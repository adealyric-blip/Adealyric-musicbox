...
"[project]/src/lib/product-catalog.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/shop-catalog.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// shop-catalog.ts — Static product catalog for the shop
// NO database, NO client/server directives. Pure exported TypeScript data.
// ── Types ──────────────────────────────────────────────────────────────────
__turbopack_context__.s([
    "getAllBadges",
    ()=>getAllBadges,
...
function parseSizes(s) {
    if (!s || s === '—' || s === '-') return [];
    s = s.trim();
    if (s.toLowerCase() === 'one size') return [
        'One Size'
    ];
    if (s.toLowerCase().startsWith('one size')) return [
        s
    ];
    // Handle comma-separated like "2-4-10-12"
    ...
    if (parts.length === 2) {
        ...
        if (SIZE_CODES.includes(start) && SIZE_CODES.includes(end)) {
            const si = SIZE_CODES.indexOf(start);
            const ei = SIZE_CODES.indexOf(end);
            return SIZE_CODES.slice(si, ei + 1);
        }
        const sn = parseInt(start);
        const en = parseInt(end);
        if (!isNaN(sn) && !isNaN(en) && sn < en) {
            const nums = [];
            const step = en - sn <= 4 ? 1 : 2;
            for(let i = sn; i <= en; i += step)nums.push(String(i));
            return nums;
        }
        return [
            start,
...
function parseBadges(b) {
    if (!b || b === '—' || b === '-') return [];
    return b.split(',').map((x)=>x.trim()).filter(Boolean);
}
...
const p = (overrides)=>{
    _counter++;
    const slug = overrides.name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-+/g, '-').replace(/^-|-$/g, '');
    return {
        id: `shop-${_counter}`,
        slug,
        badges: [],
...
function apparel(dept, cat, sub, rows) {
    return rows.map(([name, sku, sizes, cc, fabric, price, badge], i)=>p({
            name,
            sku: sku || undefined,
            sizes,
            sizeList: parseSizes(sizes),
            colorCount: cc,
            fabric,
            price,
            badges: parseBadges(badge),
            department: dept,
            category: cat,
...
function activewearSub(name) {
    if (/Sports Bra/i.test(name)) return 'Sports Bras';
    if (/Romper|Set/i.test(name)) return 'Sports Sets';
    if (/Shorts|Biker/i.test(name)) return 'Yoga Shorts';
    if (/Pants|Leggings/i.test(name)) return 'Yoga Pants';
    return 'Athletic Tops';
}
function onePieceCat(name) {
    if (/Bodysuit/i.test(name)) return {
        category: 'Bodysuits & Jumpsuits',
        subcategory: 'Bodysuits'
    };
    if (/Jumpsuit/i.test(name)) return {
        category: 'Bodysuits & Jumpsuits',
        subcategory: 'Jumpsuits'
    };
    if (/Romper/i.test(name)) return {
        category: 'Bodysuits & Jumpsuits',
        subcategory: 'Rompers'
    };
    return {
...
// ── PART A: Women's Apparel (SKU-coded) ───────────────────────────────────
// A1. T-Shirts (74 SKUs)
const a1Tshirts = apparel('Women', 'T-Shirts', undefined, [
    [
        "Women's Regular Fit Crewneck T-Shirt",
        "WT0216",
        "S–2XL",
        5,
        "130gsm/3.8oz",
    ...
    [
        "Women's Leopard Print Crop T-Shirt",
        "WT0218",
        "S–2XL",
        4,
        "210gsm/6.2oz",
    ...
    [
        "Women's Boatneck Raglan T-Shirt",
        "WT0200",
        "S–XL",
        6,
        "230gsm/6.8oz",
    ...
    [
        "Women's Crop Short Sleeve Shirt",
        "WT0225",
        "S–XL",
        3,
        "270gsm/8.0oz",
    ...
    [
        "Women's Turtleneck Batwing T-Shirt",
        "WO0019",
        "S–L",
        4,
        "210gsm/6.2oz",
    ...
    [
        "Women's Slim Half-Button T-Shirt",
        "WT0183",
        "S–2XL",
        5,
        "260gsm/7.7oz",
    ...
    [
        "Women's Raglan Color Block Baby T-Shirt",
        "WT0197",
        "S–XL",
        12,
        "230gsm/6.8oz",
    ...
    [
        "Essential Bodycon Crewneck T-Shirt",
        "WT0050",
        "S–XL",
        7,
        "260gsm/7.7oz",
    ...
    [
        "Baby Tee Seamless T-Shirt – 200 GSM",
        "RU0007",
        "S–L",
        2,
        "200gsm/5.9oz",
    ...
    [
        "Women's Mineral Wash Cotton Crop T-Shirt",
        "WT0137",
        "S–2XL",
        4,
        "275gsm/8.1oz",
    ...
    [
        "Women's Cropped Dolman T-Shirt",
        "WB0015",
        "S–XL",
        4,
        "260gsm/7.7oz",
    ...
    [
        "Essential Standard Shoulder T-Shirt",
        "WT0040",
        "S–XL",
        8,
        "250gsm/7.4oz",
    ...
    [
        "Women's Off-the-Shoulder Bell Sleeve Crop T-Shirt",
        "WT0112",
        "S–XL",
        3,
        "260gsm/7.7oz",
    ...
    [
        "Contrast Stripes Bodycon Raglan Sleeve T-Shirt",
        "WT0029",
        "S–XL",
        5,
        "260gsm/7.7oz",
    ...
    [
        "Women's Solid Color Slim Crop T-Shirt",
        "WT0080",
        "S–XL",
        7,
        "260gsm/7.7oz",
    ...
    [
        "Vintage Wash Drop Shoulder T-shirt",
        "WT0030",
        "S–XL",
        3,
        "275gsm/8.1oz",
    ...
    [
        "Women's Mineral Wash Raglan Crop T-Shirt",
        "WT0108",
        "S–XL",
        2,
        "315gsm/9.3oz",
    ...
    [
        "Women's One-Shoulder Crop T-Shirt",
        "",
        "S–XL",
        6,
        "250gsm/7.4oz",
    ...
    [
        "Women's Boxy Batwing Sleeve T-Shirt",
        "WT0107",
        "S–XL",
        4,
        "190gsm/5.6oz",
    ...
    [
        "Women's Slim Ribbed Crop T-Shirt",
        "WT0062",
        "S–XL",
        6,
        "250gsm/7.4oz",
    ...
    [
        "Women's Retro Binding V-Neck Crop T-Shirt",
        "WT0089",
        "S–XL",
        4,
        "210gsm/6.2oz",
    ...
    [
        "Women's Cropped Full Zip Short Sleeve T-Shirt",
        "WT0111",
        "S–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Vintage Washed Bodycon Cotton T-Shirt",
        "WT0002",
        "S–XL",
        6,
        "280gsm/8.3oz",
    ...
    [
        "Women's Color Block V-Neck Crop T-Shirt",
        "WT0084",
        "S–XL",
        2,
        "260gsm/7.7oz",
    ...
    [
        "Women's Slim Fit Crewneck T-Shirt",
        "WT0053",
        "S–2XL",
        5,
        "250gsm/7.4oz",
    ...
    [
        "Essential Wide Neck Baby T-shirt",
        "WT0041",
        "S–XL",
        4,
        "260gsm/7.7oz",
    ...
    [
        "Women's Quick-Dry Baby T-Shirt",
        "WT0128",
        "S–2XL",
        6,
        "240gsm/7.1oz",
    ...
    [
        "Off-Shoulder Rolled Hem Cotton T-Shirt",
        "AWT002",
        "S–2XL",
        4,
        "190gsm/5.6oz",
    ...
    [
        "Women's Slim Color Block T-Shirt",
        "WT0158",
        "4–12",
        8,
        "180gsm/5.3oz",
    ...
    [
        "Women's Square Neck Crop T-Shirt",
        "WT0077",
        "S–XL",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Contrast Collar Striped Cropped Jersey",
        "WT0052",
        "S–XL",
        4,
        "165gsm/4.9oz",
    ...
    [
        "Women's Slim Fit Boatneck T-Shirt",
        "WT0068",
        "S–XL",
        4,
        "250gsm/7.4oz",
    ...
    [
        "Women's Vintage Wash Boxy Cropped Shirt",
        "WT0122",
        "S–XL",
        2,
        "310gsm/9.1oz",
    ...
    [
        "Asymmetric Shoulder Oversized Cotton T-Shirt",
        "AWT001",
        "S–2XL",
        3,
        "230gsm/6.8oz",
    ...
    [
        "Women's Contrast Stitch Raglan T-Shirt",
        "WT0085",
        "S–XL",
        5,
        "210gsm/6.2oz",
    ...
    [
        "Women's Color Block Raglan Baby T-Shirt",
        "WT0110",
        "S–XL",
        5,
        "210gsm/6.2oz",
    ...
    [
        "Women's Varsity Stripe T-Shirt",
        "WT0066",
        "S–2XL",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Essential Slim Fit Mock Neck T-Shirt",
        "WT0042",
        "S–XL",
        5,
        "260gsm/7.7oz",
    ...
    [
        "Women's Ruched Long Sleeve Crop T-Shirt",
        "WT0060",
        "S–XL",
        6,
        "250gsm/7.4oz",
    ...
    [
        "Women's Cropped Paneled V-Neck Jersey",
        "WT0138",
        "S–XL",
        4,
        "180gsm/5.3oz",
    ...
    [
        "Women's Slim Cap Sleeve Crop T-Shirt",
        "WT0081",
        "S–XL",
        7,
        "260gsm/7.7oz",
    ...
    [
        "Women's Camo Raglan Crop T-Shirt",
        "WT0140",
        "S–XL",
        2,
        "210gsm/6.2oz",
    ...
    [
        "Women's Paneling Full Zip T-Shirt",
        "WT0173",
        "S–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Longline Slim-Fit T-Shirt",
        "WT0075",
        "S–2XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Off-the-Shoulder Crop T-Shirt",
        "WT0104",
        "S–XL",
        4,
        "310gsm/9.1oz",
    ...
    [
        "Women's Striped Boxy Cropped Shirt",
        "WT0155",
        "S–XL",
        1,
        "108gsm/3.2oz",
    ...
    [
        "Women's Contrast Stitch Raglan Crop T-Shirt",
        "WT0095",
        "S–XL",
        5,
        "210gsm/6.2oz",
    ...
    [
        "Tencel Slim Fit V-Neck T-Shirt",
        "WT0054",
        "S–2XL",
        6,
        "220gsm/6.5oz",
    ...
    [
        "Women's Mineral Wash Crop T-Shirt",
        "WT0097",
        "S–XL",
        6,
        "260gsm/7.7oz",
    ...
    [
        "Women's Color Block Ruched T-Shirt",
        "",
        "S–XL",
        3,
        "210gsm/6.2oz",
    ...
    [
        "Essential V-Neck Bodycon T-Shirt",
        "WT0005",
        "S–2XL",
        4,
        "215gsm/6.3oz",
    ...
    [
        "Contrast Trim V-Neck Crop T-Shirt",
        "WT0051",
        "S–XL",
        2,
        "260gsm/7.7oz",
    ...
    [
        "Women's Raw Hem Long Sleeve T-Shirt",
        "WT0103",
        "S–XL",
        4,
        "310gsm/9.1oz",
    ...
    [
        "Women's Sunfade Washed T-Shirt",
        "WT0165",
        "S–2XL",
        5,
        "270gsm/8.0oz",
    ...
    [
        "Lightweight Cocoon Shape Short Sleeve Top",
        "WT0008",
        "S–L",
        3,
        "210gsm/6.2oz",
    ...
    [
        "Women's Slim Fit Color Block T-Shirt",
        "WT0166",
        "S–XL",
        6,
        "200gsm/5.9oz",
    ...
    [
        "Women's Piping Baseball Jersey",
        "WT0139",
        "S–XL",
        4,
        "250gsm/7.4oz",
    ...
    [
        "Women's Slim Fit Paneling T-Shirt",
        "WT0177",
        "S–XL",
        6,
        "260gsm/7.7oz",
    ...
    [
        "Women's Crop Bubble Hem T-Shirt",
        "WT0160",
        "S–XL",
        3,
        "200gsm/5.9oz",
...
const a2Tanks = apparel('Women', 'T-Shirts', 'Tank Tops & Camis', [
    [
        "Women's Tight Crewneck Crop Tank Top",
        "WT0082",
        "S–XL",
        5,
        "260gsm/7.7oz",
    ...
    [
        "Women's Leopard print Tank Top",
        "WT0185",
        "S–2XL",
        2,
        "210gsm/6.2oz",
    ...
    [
        "Women's One-Shoulder Crop Tank Top",
        "WT0079",
        "S–XL",
        6,
        "260gsm/7.7oz",
    ...
    [
        "Women's Color Block Halter Crop Tank Top",
        "WT0083",
        "S–XL",
        5,
        "210gsm/6.2oz",
    ...
    [
        "Solid Color Raglan Sleeve Crop Top",
        "WT0009",
        "S–L",
        3,
        "210gsm/6.2oz",
    ...
    [
        "Women's Color Block Cropped Tank Top",
        "WT0116",
        "S–XL",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Slim Fit Ribbed Racerback Tank Top",
        "RB0017",
        "S–XL",
        4,
        "280gsm/8.3oz",
    ...
    [
        "Contrast Binding Halter Tank Top",
        "WB0001",
        "S–XL",
        3,
        "210gsm/6.2oz",
    ...
    [
        "Women's Ribbed Henley Tank Top",
        "WT0076",
        "S–2XL",
        3,
        "250gsm/7.4oz",
    ...
    [
        "Color-Blocked Raglan Sleeve Crop Top",
        "WT0006",
        "S–L",
        3,
        "210gsm/6.2oz",
...
// A3. Hoodies (15 SKUs)
const a3Hoodies = apparel('Women', 'Hoodies', undefined, [
    [
        "Women's Mineral Washed Crop Hoodie",
        "WT0192",
        "S–2XL",
        4,
        "400gsm/11.8oz",
    ...
    [
        "Vintage Washed Raw Edge Hoodie",
        "WW0005",
        "S–XL",
        5,
        "320gsm/9.4oz",
    ...
    [
        "Essential Cropped Zip-Up Hoodie",
        "WQ0002",
        "S–XL",
        4,
        "350gsm/10.3oz",
    ...
    [
        "Vintage Washed Cropped Fleece Hoodie",
        "WW0006",
        "M–XL",
        3,
        "400gsm/11.8oz",
    ...
    [
        "Women's Slim Cropped Full Zip Hoodie",
        "WT0102",
        "S–XL",
        4,
        "260gsm/7.7oz",
    ...
    [
        "Women's Slim Crop Full Zip Hoodie",
        "WT0114",
        "S–XL",
        4,
        "310gsm/9.1oz",
    ...
    [
        "Women's Boxy Quarter-Zip Hoodie",
        "WT0113",
        "S–XL",
        4,
        "310gsm/9.1oz",
    ...
    [
        "Contrast Side Stripe Cropped Hoodie",
        "WW0012",
        "S–XL",
        3,
        "340gsm/10.0oz",
...
const a4Sweatshirts = apparel('Women', 'Sweatshirts', undefined, [
    [
        "Women's Mock Neck Crewneck Sweatshirt",
        "WT0211",
        "S–L",
        8,
        "350gsm/10.3oz",
    ...
    [
        "Women's Collared Pullover Knit Sweater",
        "WT0203",
        "S–XL",
        4,
        "420gsm/12.4oz",
    ...
    [
        "Women's Mock-Neck Quarter-Zip Sweatshirt",
        "WT0187",
        "S–XL",
        4,
        "420gsm/12.4oz",
    ...
    [
        "Women's Crop V-Neck Sweatshirt",
        "WB0067",
        "S–XL",
        5,
        "280gsm/8.3oz",
    ...
    [
        "Women's Crop Collared Sweatshirt",
        "WT0212",
        "S–2XL",
        4,
        "410gsm/12.1oz",
    ...
    [
        "Women's Off-Shoulder Sweatshirt",
        "WT0058",
        "S–XL",
        5,
        "250gsm/7.4oz",
    ...
    [
        "Raw-Hem Color-Block Raglan Crop Sweatshirt",
        "WW0001",
        "S–XL",
        4,
        "420gsm/12.4oz",
    ...
    [
        "Snow Washed Raw Edge Cropped Sweatshirt",
        "RW0004",
        "S–XL",
        4,
        "380gsm/11.2oz",
    ...
    [
        "Vintage Washed Cropped Sweatshirt",
        "WW0016",
        "S–L",
        4,
        "410gsm/12.1oz",
    ...
    [
        "Women's Boxy Cropped Crewneck Sweatshirt",
        "WT0123",
        "S–XL",
        3,
        "310gsm/9.1oz",
    ...
    [
        "Essential Fleece Mock-Neck Crew Sweatshirt",
        "WW0004",
        "S–L",
        6,
        "350gsm/10.3oz",
    ...
    [
        "Mineral Wash Balloon Sleeve Cropped Sweater",
        "WM0001",
        "S–XL",
        3,
        "285gsm/8.4oz",
...
// A5. Activewear (85 SKUs)
const a5Activewear = [
    [
        "Women's Tight Yoga Sports Bra",
        "WT0205",
        "S–XL",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Women's Ruched Halter Neck Yoga Tank Top",
        "WT0206",
        "S–XL",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Halter Yoga Sports Bra",
        "WT0189",
        "4–12",
        3,
        "270gsm/8.0oz",
    ...
    [
        "Women's High Rise Ankle Length Yoga Leggings",
        "WB0072",
        "4–12",
        3,
        "270gsm/8.0oz",
    ...
    [
        "Women's Halter V-Neck Yoga Tank Top",
        "WT0194",
        "S–XL",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Color Block Yoga Tank Top",
        "WT0219",
        "2XS–XL",
        8,
        "225gsm/6.6oz",
    ...
    [
        "Women's Quarter-Zip Yoga Romper",
        "WB0076",
        "S–XL",
        6,
        "230gsm/6.8oz",
    ...
    [
        "Women's Flared Drawstring Yoga Pants",
        "WB0074",
        "4–12",
        3,
        "240gsm/7.1oz",
    ...
    [
        "Women's Topstitching Yoga Sports Bra",
        "WT0179",
        "S–XL",
        9,
        "220gsm/6.5oz",
    ...
    [
        "Women's Topstitching Yoga Tank Top",
        "WT0180",
        "S–XL",
        10,
        "220gsm/6.5oz",
    ...
    [
        "Women's Performance Crop T-Shirt",
        "WT0181",
        "2XS–XL",
        6,
        "220gsm/6.5oz",
    ...
    [
        "Women's High Rise Topstitching Leggings",
        "WB0040",
        "S–XL",
        11,
        "220gsm/6.5oz",
    ...
    [
        "Women's High Rise Flared Yoga Pants",
        "WB0041",
        "S–XL",
        11,
        "220gsm/6.5oz",
    ...
    [
        "Women's Color Block Yoga Sports Bra",
        "WT0178",
        "2XS–XL",
        5,
        "250gsm/7.4oz",
    ...
    [
        "Women's Color Block Performance T-Shirt",
        "UT0167",
        "2XS–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's High Rise Color Block Yoga Shorts",
        "WB0068",
        "2XS–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Hollow-Out Yoga Tank Top",
        "WT0149",
        "4–12",
        3,
        "260gsm/7.7oz",
    ...
    [
        "Women's Color Block Yoga Leggings",
        "WB0065",
        "2XS–XL",
        6,
        "250gsm/7.4oz",
    ...
    [
        "Women's Slim Fit Performance T-Shirt",
        "WT0143",
        "2XS–XL",
        12,
        "220gsm/6.5oz",
    ...
    [
        "Spaghetti Strap Yoga Sports Bra",
        "WT0073",
        "S–XL",
        12,
        "300gsm/8.8oz",
    ...
    [
        "Women's High-Waist Tapered Leggings",
        "WB0042",
        "S–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Pleated Halter Sports Bra",
        "",
        "S–2XL",
        12,
        "220gsm/6.5oz",
    ...
    [
        "Women's Contrast Stripe Track Shorts",
        "WB0014",
        "S–2XL",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Halter Neck Yoga Sports Bra",
        "WT0136",
        "S–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's High-Waisted Ankle Length Yoga Leggings",
        "WB0020",
        "4–12",
        7,
        "220gsm/6.5oz",
    ...
    [
        "Strappy Criss-Cross Sports Bra",
        "WT0074",
        "4–12",
        10,
        "210gsm/6.2oz",
    ...
    [
        "Women's Solid Color Sports Bra",
        "WT0109",
        "S–XL",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Women's Tight Long Sleeve Yoga Bodysuit",
        "",
        "S–2XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Crossover V-Neck Sports Bra",
        "WT0065",
        "S–2XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "High-Waisted Blend Biker Shorts",
        "WB0012",
        "S–2XL",
        6,
        "220gsm/6.5oz",
    ...
    [
        "Women's Slim Fit Full-Zip Yoga Jacket",
        "WT0118",
        "S–2XL",
        3,
        "230gsm/6.8oz",
    ...
    [
        "Women's V-Neck Yoga Sports Bra",
        "WT0125",
        "4–12",
        21,
        "210gsm/6.2oz",
    ...
    [
        "Women's High Waisted Ankle Leggings",
        "WB0035",
        "4–12",
        8,
        "220gsm/6.5oz",
    ...
    [
        "Women's Tight Color Block Yoga Tank Top",
        "WT0152",
        "4–12",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's High Rise Pocket Yoga Shorts",
        "WB0055",
        "S–XL",
        9,
        "230gsm/6.8oz",
    ...
    [
        "Women's Cutout Long Sleeve Yoga Shrug",
        "WT0157",
        "S–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's High-Waisted Flare Leggings",
        "WB0003",
        "S–XL",
        11,
        "220gsm/6.5oz",
    ...
    [
        "Women's Halter Crop Sports Bra",
        "WT0099",
        "4–12",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's High-Waisted Pocket Biker Shorts",
        "WB0006",
        "S–2XL",
        4,
        "210gsm/6.2oz",
    ...
    [
        "Women's Tight Fit Yoga Tank Top",
        "WT0146",
        "4–12",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Tight Cropped Sports Bra",
        "",
        "4–12",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Solid U-Neck Sports Bra",
        "WT0131",
        "S–XL",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Women's Solid Color Yoga Sports Bra",
        "WT0132",
        "4–12",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Strappy Criss Cross Yoga Sports Bra",
        "WT0064",
        "S–2XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Taped Cooling Performance Crop Top",
        "RT0035",
        "S–XL",
        2,
        "230gsm/6.8oz",
    ...
    [
        "Women's Twist Front V-Neck Sports Bra",
        "WT0129",
        "S–XL",
        11,
        "220gsm/6.5oz",
    ...
    [
        "Women's Color Block Ruched V-Neck Sports Bra",
        "WT0121",
        "S–XL",
        4,
        "230gsm/6.8oz",
    ...
    [
        "Women's High-Waist Yoga Shorts",
        "WB0051",
        "4–12",
        7,
        "215gsm/6.3oz",
    ...
    [
        "Women's Tight Halter Yoga Tank Top",
        "WT0150",
        "4–12",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Cropped V-Neck Sports Bra",
        "WT0144",
        "S–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's High Rise Flared Leggings",
        "WB0054",
        "4–12",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's U-Neck Yoga Sports Bra",
        "WT0168",
        "4–12",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Women's Tight Paneling Yoga Tank Top",
        "WT0154",
        "4–12",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Criss-Cross Band Sports Bra",
        "WT0127",
        "2XS–XL",
        4,
        "250gsm/7.4oz",
    ...
    [
        "Women's Ruched Halter-Neck Sports Bra",
        "WT0133",
        "S–XL",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Women's High-Waist Color Block Yoga Shorts",
        "WB0046",
        "S–XL",
        7,
        "220gsm/6.5oz",
    ...
    [
        "Women's Faux Denim Zip-Fly Leggings",
        "WB0019",
        "4–12",
        2,
        "200gsm/5.9oz",
    ...
    [
        "Women's High Rise Tight Yoga Shorts",
        "WB0053",
        "4–12",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Crewneck Yoga Tank Top",
        "WT0153",
        "4–12",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Women's High Rise Straight Leg Yoga Pants",
        "WB0052",
        "4–12",
        10,
        "230gsm/6.8oz",
    ...
    [
        "Women's Ruched Cropped Yoga Tube Top",
        "WT0141",
        "S–XL",
        5,
        "240gsm/7.1oz",
...
].map(([name, sku, sizes, cc, fabric, price, badge], i)=>p({
        name: name,
        sku: sku || undefined,
        sizes: sizes,
        sizeList: parseSizes(sizes),
        ...
        department: 'Women',
        category: 'Activewear',
        subcategory: activewearSub(name),
        sortOrder: i
    }));
// A6. Shorts (7 SKUs)
const a6Shorts = apparel('Women', 'Bottoms', 'Shorts', [
    [
        "Women's Drawstring Bermuda Shorts",
        "WB0073",
        "4–12",
        5,
        "140gsm/4.1oz",
    ...
    [
        "Women's Vintage Wash Raw Hem Denim Shorts",
        "WB0034",
        "S–XL",
        1,
        "430gsm/12.7oz",
    ...
    [
        "Women's Retro Contrast Binding Shorts",
        "WB0030",
        "S–XL",
        5,
        "220gsm/6.5oz",
    ...
    [
        "Snow Washed Raw Edge Drawstring Shorts",
        "",
        "S–XL",
        2,
        "300gsm/8.8oz",
    ...
    [
        "Women's Vintage Wash High Rise Denim Shorts",
        "WB0058",
        "S–XL",
        2,
        "280gsm/8.3oz",
...
const a7Sweatpants = apparel('Women', 'Bottoms', 'Trousers', [
    [
        "Women's Mineral Wash Flared Leg Sweatpants",
        "WB0075",
        "S–2XL",
        4,
        "400gsm/11.8oz",
    ...
    [
        "Essential Fleece Drawstring Sweatshorts",
        "WK0004",
        "S–L",
        6,
        "350gsm/10.3oz",
    ...
    [
        "Essential Straight-Leg Sweatpants",
        "WK0009",
        "XS–L",
        4,
        "310gsm/9.1oz",
    ...
    [
        "Essential Drawstring Straight-Leg Sweatpants",
        "WK0003",
        "S–XL",
        4,
        "350gsm/10.3oz",
    ...
    [
        "Vintage Washed Flared Fleece Pants",
        "WK0005",
        "M–XL",
        3,
        "400gsm/11.8oz",
    ...
    [
        "Women's Slim-Fit Flared Sweatpants",
        "WB0016",
        "S–XL",
        5,
        "250gsm/7.4oz",
    ...
    [
        "Vintage Washed Drawstring Sweatpants",
        "WK0016",
        "S–L",
        4,
        "410gsm/12.1oz",
...
// A8. Skirts (15 SKUs)
const a8Skirts = apparel('Women', 'Dresses', 'Skirts', [
    [
        "Women's High Rise A-Line Skirt",
        "WB0081",
        "S–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Studded Denim Mini Skirt",
        "",
        "S–2XL",
        1,
        "390gsm/11.5oz",
    ...
    [
        "Women's Pleated A-Line Tennis Skirt",
        "WB0071",
        "4–10",
        2,
        "320gsm/9.4oz",
    ...
    [
        "High-Waist Pocketed A-Line Skirt",
        "WS0004",
        "S–XL",
        3,
        "210gsm/6.2oz",
    ...
    [
        "Women's Solid Color Knit Maxi Skirt",
        "WB0027",
        "S–XL",
        3,
        "260gsm/7.7oz",
    ...
    [
        "Taped Cooling Performance Short Skirt",
        "RS0035",
        "S–XL",
        2,
        "230gsm/6.8oz",
    ...
    [
        "Dyed Washed Drawstring Maxi Skirt",
        "WS0009",
        "S–XL",
        4,
        "275gsm/8.1oz",
    ...
    [
        "Contrast Side Stripe Slit Skirt",
        "WS0012",
        "S–XL",
        3,
        "340gsm/10.0oz",
    ...
    [
        "Women's Mineral Wash Mini Skirt",
        "WB0033",
        "S–XL",
        2,
        "380gsm/11.2oz",
    ...
    [
        "Women's A-Line Contrast Panel Slit Skirt",
        "WB0047",
        "2XS–XL",
        6,
        "225gsm/6.6oz",
    ...
    [
        "Women's Vintage Wash Denim Skirt",
        "WB0049",
        "S–2XL",
        1,
        "450gsm/13.3oz",
...
// A9. Bottoms — Jeans / Trousers (16 SKUs)
const a9Bottoms = apparel('Women', 'Bottoms', 'Trousers', [
    [
        "Women's Tencel Wide Leg Pants",
        "WB0082",
        "S–2XL",
        3,
        "300gsm/8.8oz",
    ...
    [
        "Women's Splatter Barrel Leg Jeans",
        "WB0078",
        "S–3XL",
        1,
        "615gsm/18.1oz",
    ...
    [
        "Women's High Rise Wide Leg Pants",
        "WB0069",
        "XS–L",
        3,
        "140gsm/4.1oz",
    ...
    [
        "Women's High-Rise Flared Jeans",
        "WB0011",
        "S–XL",
        1,
        "385gsm/11.4oz",
    ...
    [
        "Women's Vintage Wash Flared Leg Jeans",
        "WB0021",
        "S–XL",
        3,
        "370gsm/10.9oz",
    ...
    [
        "Women's Vintage Wash Distressed Wide Leg Jeans",
        "WB0032",
        "S–XL",
        1,
        "400gsm/11.8oz",
    ...
    [
        "Women's Vintage Wash Wide Leg Jeans",
        "WB0036",
        "S–XL",
        1,
        "400gsm/11.8oz",
    ...
    [
        "Women's Drawstring Flared Leg Pants",
        "WB0029",
        "S–XL",
        4,
        "310gsm/9.1oz",
    ...
    [
        "Women's Vintage Wash High Rise Wide Leg Jeans",
        "WB0057",
        "S–2XL",
        1,
        "426gsm/12.6oz",
...
// A10. One-Pieces — Dresses / Rompers / Jumpsuits / Bodysuits (16 SKUs)
const a10OnePieces = [
    [
        "Women's U-Neck Yoga Romper",
        "WO0018",
        "S–XL",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Striped Color Block Polo Dress",
        "WT0209",
        "S–L",
        5,
        "210gsm/6.2oz",
    ...
    [
        "Women's A-Line Sleeveless Dress",
        "WO0014",
        "S–XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Solid Tight Sleeveless Dress",
        "WO0002",
        "XS–L",
        3,
        "260gsm/7.7oz",
    ...
    [
        "Women's Mineral Wash Crewneck Bodysuit",
        "WT0091",
        "S–2XL",
        1,
        "275gsm/8.1oz",
    ...
    [
        "Women's Tight Flared Leg Quarter-Zip Jumpsuit",
        "WO0009",
        "S–XL",
        5,
        "230gsm/6.8oz",
    ...
    [
        "Women's Halter Flared Jumpsuit",
        "WO0013",
        "S–2XL",
        4,
        "220gsm/6.5oz",
    ...
    [
        "Women's Color Block Mini Dress",
        "WO0004",
        "S–XL",
        3,
        "260gsm/7.7oz",
    ...
    [
        "Women's Quarter-Zip Short Sleeve Romper",
        "WO0012",
        "S–XL",
        5,
        "230gsm/6.8oz",
    ...
    [
        "Women's Collared Halter A-Line Tennis Dress",
        "WO0008",
        "S–2XL",
        5,
        "210gsm/6.2oz",
    ...
    [
        "Women's V-Neck Short Sleeve Maxi Dress",
        "WO0001",
        "S–XL",
        3,
        "260gsm/7.7oz",
    ...
    [
        "Women's Binding Tight Halter Dress",
        "WO0005",
        "S–XL",
        3,
        "210gsm/6.2oz",
    ...
    [
        "Women's Dual-Function Cape Tie-Waist Romper",
        "WO0006",
        "S–2XL",
        5,
        "250gsm/7.4oz",
    ...
    [
        "Women's Color Block A-Line Sleeveless Dress",
        "WO0011",
        "2XS–XL",
        3,
        "220gsm/6.5oz",
    ...
    [
        "Women's Full-Zip Ruched Bodysuit",
        "WT0176",
        "S–XL",
        3,
        "315gsm/9.3oz",
    ...
    [
        "Women's Ruched Sleeveless Full-Zip Dress",
        "WO0015",
        "S–XL",
        8,
        "220gsm/6.5oz",
...
].map(([name, sku, sizes, cc, fabric, price, badge], i)=>{
    const cat = onePieceCat(name);
    return p({
        name: name,
        sku: sku || undefined,
        sizes: sizes,
...
const a11Coats = apparel('Women', 'Outerwear', undefined, [
    [
        "Women's Mock Neck Zip Up Cardigan",
        "",
        "S–XL",
        4,
        "420gsm/12.4oz",
    ...
    [
        "Women's Full-Zip Sports Jacket",
        "WT0162",
        "S–XL",
        3,
        "230gsm/6.8oz",
    ...
    [
        "Contrast Side Stripe Fleece Cropped Track Jacket",
        "WQ0004",
        "S–XL",
        4,
        "420gsm/12.4oz",
...
const a12Polos = apparel('Women', 'T-Shirts', 'Polo Shirts', [
    [
        "Women's Slim Fit Quarter-Zip Polo Shirt",
        "WT0163",
        "2XS–XL",
        5,
        "160gsm/4.7oz",
    ...
    [
        "Bodycon Short Sleeve Polo Shirt",
        "PL0008",
        "S–XL",
        3,
        "260gsm/7.7oz",
    ...
    [
        "Women's Knit Cotton Polo Shirt",
        "WT0172",
        "S–XL",
        4,
        "180gsm/5.3oz",
...
function extractProcessTags(name) {
    const tags = [];
    const patterns = [
        [
            /\(All-Over Printing\)/i,
        ...
        [
            /\(Front Printing\)|Front Prints?\b/i,
            'Front Printing'
        ],
        [
            /\(Dual-Sided Printing\)|Dual-Sided Prints?|Dual-sided/i,
            'Dual-Sided Printing'
        ],
        [
            /\(Back Printing\)|Back Printed|Back Print/i,
            'Back Printing'
        ],
        [
            /\bDTG\b/i,
        ...
        [
            /\(Dual-sided Printing\)/i,
            'Dual-Sided Printing'
        ]
    ];
    for (const [pat, tag] of patterns){
        if (pat.test(name) && !tags.includes(tag)) tags.push(tag);
    }
    return tags;
}
function categorizePartB(name) {
    if (/Swimsuit|Bikini|Tankini|Swim\b|Cover-?up|Swimwear/.test(name)) return {
        category: 'Swimwear'
    };
    if (/Yoga|Leggings|Sports Bra|Sports Tank/.test(name)) return {
        category: 'Activewear'
    };
    if (/\bHoodie\b/.test(name)) return {
        category: 'Hoodies'
    };
    if (/\bSweatshirt\b/.test(name)) return {
        category: 'Sweatshirts'
    };
    if (/\bJacket\b|\bOuterwear\b/.test(name)) return {
        category: 'Outerwear'
    };
    if (/\bVest\b|\bCardigan\b/.test(name)) return {
        category: 'Outerwear'
    };
    if (/\bJumpsuit\b|\bBodysuit\b/.test(name)) return {
        category: 'Bodysuits & Jumpsuits',
        subcategory: 'Jumpsuits'
    };
    if (/Pajama|Nightdress|Nightgown|Loungewear|Robe|Sleep/.test(name)) return {
        category: 'Lingerie & Sleep'
    };
    if (/Underwear|Thong|Panties|Briefs|G-?String|Lingerie|Tanga/.test(name)) return {
        category: 'Lingerie & Sleep',
        subcategory: 'Underwear'
    };
    if (/\bDress\b/.test(name)) return {
        category: 'Dresses'
    };
    if (/\bPants\b|\bJogger\b|\bSweatpant/.test(name)) return {
        category: 'Bottoms'
    };
    if (/\bShorts?\b/.test(name)) return {
        category: 'Bottoms',
        subcategory: 'Shorts'
    };
    if (/\bSkirt\b|\bSkort\b/.test(name)) return {
        category: 'Dresses',
        subcategory: 'Skirts'
    };
    if (/\bTank\b|Camisole|\bCami\b/.test(name)) return {
        category: 'T-Shirts',
        subcategory: 'Tank Tops & Camis'
    };
    if (/\bCrop\b/.test(name)) return {
        category: 'T-Shirts',
        subcategory: 'Crop Tops'
    };
    if (/Polo|POLO/i.test(name)) return {
        category: 'T-Shirts',
        subcategory: 'Polo Shirts'
    };
    if (/\bSet\b|Cheerleader/.test(name)) return {
        category: 'Bodysuits & Jumpsuits',
        subcategory: 'Rompers'
    };
    if (/\bSweater\b|Pullover/.test(name)) return {
        category: 'Sweatshirts'
    };
    if (/T-?Shirt|Tee|Shirt|Blouse|Jersey|Top/.test(name)) return {
        category: 'T-Shirts'
    };
    return {
        category: 'T-Shirts'
...
const partBRaw = [
    [
        "Women's shirts (All-Over Printing)",
        "S–3XL",
        9.28,
        ""
    ],
    [
        "Best Hoodies-Double-Layer Cap Women's Hoodies",
        "S–6XL",
        9.92,
        ""
    ],
    [
        "Loose High Waisted Shorts (All-Over Printing)",
        "S–3XL",
        7.46,
        ""
    ],
    [
        "Women Top T-Shirts (All-Over Printing)",
        "S–6XL",
        5.74,
        ""
    ],
    [
        "DTG Personalized T-Shirts-Dual-Sided Printing",
        "S–3XL",
        5.91,
        ""
    ],
    [
        "Sports Bra Designs-Yoga Support Bras (All-Over Printing)",
        "S–2XL",
        7.14,
        ""
    ],
    [
        "Honeycomb Textured Yoga Pants for Women",
        "S–2XL",
        10.14,
        ""
    ],
    [
        "Crewneck T-Shirts (All-Over Printing)",
        "S–5XL",
        5.76,
        ""
    ],
    [
        "Mom Shirts (All-Over Printing)",
        "XS–5XL",
        6.39,
        ""
    ],
    [
        "Swimsuit Cover-up (All-Over Printing)",
        "One size",
        13.63,
        ""
    ],
    [
        "Baggy Pants for Women (All-Over Printing)",
        "S–2XL",
        7.03,
        ""
    ],
    [
        "Sleeveless Ankle-length Dress (All-Over Printing)",
        "S–5XL",
        10.24,
        ""
    ],
    [
        "V-Neck Baggy Dress with Pocket",
        "S–5XL",
        8.31,
        ""
    ],
    [
        "Summer Sweet Bowknot Dress (All-Over Printing)",
        "2XS–6XL",
        12.77,
        ""
    ],
    [
        "Designer T-Shirts for Women-Front Prints",
        "S–2XL",
        6.98,
        ""
    ],
    [
        "Designed Women's Hoodies Front Prints",
        "S–3XL",
        10.03,
        ""
    ],
    [
        "Hoodies for Women Dual-Sided Prints",
        "S–3XL",
        12.17,
        ""
    ],
    [
        "T-Shirts for Women-Printed Tees (Front Printing)",
        "L–3XL",
        4.91,
        ""
    ],
    [
        "Patterned Ribbed Yoga Sets (All-Over Printing)",
        "S–2XL",
        8.53,
        ""
    ],
    [
        "DTF Designed Women's T-Shirts-Dual-Sided Printing",
        "S–2XL",
        8.14,
        ""
    ],
    [
        "Women's Tank Top (All-Over Printing)",
        "S–2XL",
        5.10,
        ""
    ],
    [
        "Yoga Pants with 2 Pockets (All-Over Printing)",
        "S–2XL",
        11.31,
        ""
    ],
    [
        "Yoga Tank Tops (All-Over Printing)",
        "S–2XL",
        7.24,
        ""
    ],
    [
        "Yoga Workout Outfits (All-Over Printing)",
        "XS–2XL",
        10.69,
        ""
    ],
    [
        "Women's Long Sleeve U-Neck T-Shirts (All-Over Printing)",
        "S–5XL",
        6.34,
        ""
    ],
    [
        "Round Neck Sleeveless Dress Styles",
        "XS–5XL",
        7.03,
        ""
    ],
    [
        "Cover-up Dress for Swimwear (All-Over Printing)",
        "S–2XL",
        12.45,
        ""
    ],
    [
        "Women's Halter One-Piece Swimsuits (All-Over Printing)",
        "S–2XL",
        11.31,
        ""
    ],
    ...
    [
        "Ankle-length Slip Dress (All-Over Printing)",
        "S–5XL",
        10.24,
        ""
    ],
    [
        "Beach Wrap Skirt (All-Over Printing)",
        "S–2XL",
        4.03,
        ""
    ],
    [
        "Halter Tie Front Bikini Top (All-Over Printing)",
        "S–2XL",
        5.76,
        ""
    ],
    [
        "Halter Tie Front Bikini Set (All-Over Printing)",
        "S–2XL",
        8.53,
        ""
    ],
    [
        "Two Piece Halter Swimsuit (All-Over Printing)",
        "XS–2XL",
        8.53,
        ""
    ],
    [
        "Halter Triangle Bikini (All-Over Printing)",
        "XS–2XL",
        9.39,
        ""
    ],
    [
        "2-Piece Women's Halter Tankini (All-Over Printing)",
        "XS–XL",
        11.96,
        ""
    ],
    [
        "Tankini Two Piece Swimsuit (Top Printed)",
        "S–3XL",
        12.60,
        ""
    ],
    [
        "Sweatshirt Designs Raglan Style",
        "S–3XL",
        7.84,
        ""
    ],
    [
        "Sports Bra Designs-Yoga Support Bras",
        "S–2XL",
        7.14,
        ""
    ],
    [
        "Patterned Yoga Sports Bra",
        "S–2XL",
        7.14,
        ""
    ],
    [
        "Dual-Sided Printed T-Shirts for Women",
        "S–2XL",
        9.43,
        ""
    ],
    [
        "Print Crew Neck T-Shirts for Women (Front Printing)",
        "S–3XL",
        4.31,
        ""
    ],
    [
        "St Patricks Day Shirts-Short Sleeve Raglan Tees",
        "S–3XL",
        6.60,
        ""
    ],
    ...
    [
        "Women's T-Shirts Front Prints",
        "S–2XL",
        7.50,
        ""
    ],
    [
        "Spaghetti Strap Jumpsuit (All-Over Printing)",
        "S–3XL",
        11.49,
        ""
    ],
    [
        "Tank Top Bodysuit (All-Over Printing)",
        "S–2XL",
        8.08,
        ""
    ],
    [
        "Women's 2-Piece Pajama Set (All-Over Printing)",
        "XS–6XL",
        11.74,
        ""
    ],
    [
        "Women's Pocket Hoodie Back Printed",
        "S–3XL",
        10.24,
        ""
    ],
    [
        "Women Long Sleeve Turtleneck Sweater (All-Over Printing)",
        "S–2XL",
        11.91,
        ""
    ],
    ...
    [
        "Suspender Jumpsuit (All-Over Printing)",
        "S–3XL",
        11.10,
        ""
    ],
    [
        "Women's Home Pajamas Pants (All-Over Printing)",
        "S–5XL",
        7.56,
        ""
    ],
    [
        "V-Neck Women Night Wear Suit (All-Over Printing)",
        "S–XL",
        13.20,
        ""
    ],
    [
        "Wearable Sweater Oversize",
        "One size",
        12.81,
        ""
    ],
    [
        "Long Sleeve Nightdress (All-Over Printing)",
        "S–XL",
        7.41,
        ""
    ],
    [
        "Ruffle V-Neck T-Shirt (All-Over Printing)",
        "S–5XL",
        5.91,
        ""
    ],
    [
        "Long Sleeve Drop Shoulder Open Shirt (All-Over Printing)",
        "S–2XL",
        9.75,
        ""
    ],
    [
        "Tanga for Women (All-Over Printing)",
        "S–2XL",
        3.77,
        ""
    ],
    [
        "2-Piece Ruffle Tankini Swimsuit (All-Over Printing)",
        "S–2XL",
        12.56,
        ""
    ],
    [
        "Print Patterned Yoga Pants with 2 Pockets",
        "S–2XL",
        8.70,
        ""
    ],
    [
        "Short Sleeve Loungewear Set (All-Over Printing)",
        "S–5XL",
        9.77,
        ""
    ],
    [
        "Spaghetti Dress (All-Over Printing)",
        "S–2XL",
        9.60,
        ""
    ],
    [
        "Personalized Drawstring Yoga Pants (Straight Baggy)",
        "S–3XL",
        6.34,
        ""
    ],
    [
        "Women's Bikini Bottom (All-Over Printing)",
        "S–2XL",
        5.12,
        ""
    ],
    [
        "Raglan Women's 3/4 Sleeve T-shirt",
        "S–3XL",
        6.81,
        ""
    ],
    [
        "Raglan Women's Long Sleeve T-shirt",
        "S–3XL",
        7.24,
        ""
    ],
    [
        "Women's Printed Sweatshirt (Front Printing)",
        "S–3XL",
        8.96,
        ""
    ],
    [
        "Drop shoulder Hoodie (All-Over Printing)",
        "S–4XL",
        7.24,
        ""
    ],
    [
        "1/4 Zipper Long Sleeve Zip Gym Top (All-Over Printing)",
        "S–3XL",
        9.92,
        ""
    ],
    [
        "Cotton Women's Back Print Hoodie",
        "S–3XL",
        10.03,
        ""
    ],
    [
        "Printed V-neck Cami Top (All-Over Printing)",
        "S–2XL",
        7.61,
        ""
    ],
    [
        "Short Tank Top (All-Over Printing)",
        "S–2XL",
        5.96,
        ""
    ],
    ...
    [
        "Sleeveless Crop Top (All-Over Printing)",
        "S–2XL",
        6.19,
        ""
    ],
    [
        "Women's Zipper Jacket (All-Over Printing)",
        "XS–XL",
        8.31,
        ""
    ],
    ...
    [
        "Sports Yoga Bra (All-Over Printing)",
        "S–2XL",
        6.69,
        ""
    ],
    [
        "Bell Bottoms (All-Over Printing)",
        "XS–XL",
        5.12,
        ""
    ],
    [
        "Women's Jogger Sweatpants (All-Over Printing)",
        "S–3XL",
        7.26,
        ""
    ],
    [
        "Diagonal Shoulder Two Piece Set (All-Over Printing)",
        "S–5XL",
        10.03,
        ""
    ],
    [
        "Hot Yoga Pants for Women (All-Over Printing)",
        "S–2XL",
        10.03,
        ""
    ],
    [
        "Women Yoga Shorts (All-Over Printing)",
        "S–2XL",
        6.60,
        ""
    ],
    [
        "Women's Two Piece Swimsuit High Neck Halter Top",
        "S–2XL",
        9.62,
        ""
    ],
    [
        "High-collar Long-sleeve Bodysuit (All-Over Printing)",
        "S–2XL",
        10.20,
        ""
    ],
    [
        "V-neck 3/4 Sleeve Dress with Pockets",
        "S–5XL",
        8.06,
        ""
    ],
    [
        "One Shoulder Split Dress (All-Over Printing)",
        "XS–L",
        8.96,
        ""
    ],
    [
        "Long Sleeve Hoodie Dress (All-Over Printing)",
        "S–5XL",
        11.31,
        ""
    ],
    [
        "Short Sleeve V Neck Lovely Dress (All-Over Printing)",
        "2XS–6XL",
        10.03,
        ""
    ],
    [
        "Round Neck Short Sleeve Dress (All-Over Printing)",
        "2XS–8XL",
        11.06,
        ""
    ],
    [
        "Thong Panties (All-Over Printing)",
        "XS–XL",
        4.41,
        ""
    ],
    [
        "Cutout Bodycon Slim Fit Dress (All-Over Printing)",
        "S–5XL",
        10.03,
        ""
    ],
    [
        "Sleeveless Ladies Tank Dress (All-Over Printing)",
        "S–2XL",
        8.08,
        ""
    ],
    [
        "Women's Off the Shoulder Half-Sleeve T-shirt",
        "S–5XL",
        5.96,
        ""
    ],
    [
        "V Neck Sleeveless Dress (All-Over Printing)",
        "S–2XL",
        8.06,
        ""
    ],
    [
        "Women Short Sleeve Shirt (All-Over Printing)",
        "S–4XL",
        3.60,
        ""
    ],
    [
        "V-neck Short Sleeve T-Shirt (All-Over Printing)",
        "S–5XL",
        5.91,
        ""
    ],
    [
        "V-neck Loose Long Sleeve T-shirt (All-Over Printing)",
        "S–5XL",
        8.06,
        ""
    ],
    [
        "Women's Flower Blouse Long Sleeve (All-Over Printing)",
        "S–5XL",
        8.74,
        ""
    ],
    [
        "Short Sleeve Navel Shirt Baby Tee (All-Over Printing)",
        "S–3XL",
        2.57,
        ""
    ],
    [
        "Women's Irregular Shirt (All-Over Printing)",
        "S–8XL",
        10.41,
        ""
    ],
    [
        "Drop Shoulder Women's Open Shirt (Irregular Hem)",
        "S–2XL",
        11.70,
        ""
    ],
    [
        "Casual Long Sleeve Vintage Tour Shirt (All-Over Printing)",
        "S–3XL",
        8.10,
        ""
    ],
    [
        "Women's Straight POLO Shirt (All-Over Printing)",
        "S–5XL",
        8.74,
        ""
    ],
    [
        "Plus Size V-neck Long Sleeve Dress (All-Over Printing)",
        "S–8XL",
        8.49,
        ""
    ],
    [
        "V-neck Women Top with Quarter Sleeve (All-Over Printing)",
        "S–5XL",
        8.53,
        ""
    ],
    [
        "One-Piece Swimsuit (All-Over Printing)",
        "S–2XL",
        10.46,
        ""
    ],
    [
        "Spaghetti Strap Dress for Women (All-Over Printing)",
        "S–5XL",
        11.06,
        ""
    ],
    [
        "Yoga Knickerbockers (All-Over Printing)",
        "S–2XL",
        7.35,
        ""
    ],
    [
        "Cotton Printed Hoodie for Women (Front Printing)",
        "S–3XL",
        10.03,
        ""
    ],
    ...
    [
        "Women's Graphic Hoodie (All-Over Printing)",
        "S–3XL",
        6.84,
        ""
    ],
    [
        "Cotton Women's Size Hoodie with Pocket",
        "S–3XL",
        10.24,
        ""
    ],
    [
        "Full Zipper Long Sleeve Hoodie (All-Over Printing)",
        "S–5XL",
        13.63,
        ""
    ],
    [
        "Hooded Pullover (All-Over Printing)",
        "S–5XL",
        11.10,
        ""
    ],
    [
        "Poncho-style Long Sleeve Hoodie (Irregular Hem)",
        "S–5XL",
        12.77,
        ""
    ],
    [
        "Cotton Women's Hoodie with Pocket (Dual-sided)",
        "S–3XL",
        12.17,
        ""
    ],
    [
        "Lady Hoodie with Double-layer Cap",
        "S–5XL",
        7.05,
        ""
    ],
    [
        "Hoodie for Women with Double-layer Cap",
        "S–6XL",
        7.63,
        ""
    ],
    [
        "Lightweight Women's Hoodie (All-Over Printing)",
        "S–5XL",
        4.84,
        ""
    ],
    [
        "Turtle Neck Long Dress for Women (All-Over Printing)",
        "XS–XL",
        11.91,
        ""
    ],
    [
        "Loose Long-sleeve Dress with Pockets",
        "S–5XL",
        8.06,
        ""
    ],
    [
        "Sleeveless High Waist Dress (All-Over Printing)",
        "S–2XL",
        13.80,
        ""
    ],
    [
        "Long Dress Set (All-Over Printing)",
        "S–5XL",
        9.81,
        ""
    ],
    [
        "Plus Size Halter Tie Front Bikini Set",
        "XL–4XL",
        9.17,
        ""
    ],
    [
        "Plus Size Two Piece Swimsuit High Neck Halter Top",
        "XL–4XL",
        10.26,
        ""
    ],
    [
        "Multi-Strap Lace Briefs (All-Over Printing)",
        "S–2XL",
        5.31,
        ""
    ],
    [
        "Sexy One Piece Women Lingerie Bodysuit Deep V Teddy",
        "S–3XL",
        6.34,
        ""
    ],
    [
        "Faux Cotton Women Zip up Jumpsuit Pajama",
        "S–4XL",
        13.67,
        ""
    ],
    [
        "Women Flannel Zip up Jumpsuit Pajama",
        "S–4XL",
        14.31,
        ""
    ],
    ...
    [
        "Anti-peep Skort with Pocket",
        "S–4XL",
        5.49,
        ""
    ],
    [
        "Women Slim Fit Slip Dress",
        "S–2XL",
        7.67,
        ""
    ],
    [
        "Faux Cotton Drawstring Wide Leg Pajama Pants",
        "S–5XL",
        6.99,
        ""
    ],
    [
        "Women Washed Vintage T-Shirt (Front Printing)",
        "S–2XL",
        6.53,
        ""
    ],
    ...
    [
        "Round Neck Long Sleeve Dress with Pocket",
        "S–2XL",
        9.81,
        ""
    ],
    [
        "Sleeveless Vest (Dual-sided Printing)",
        "S–2XL",
        11.12,
        ""
    ],
    [
        "Long Sleeve Dress (All-Over Printing)",
        "S–2XL",
        7.41,
        ""
    ],
    [
        "Workout Yoga Set (All-over Printing)",
        "S–2XL",
        11.31,
        ""
    ],
    [
        "Workout Sports Bra for Women",
        "S–2XL",
        4.97,
        ""
    ],
    [
        "Knee-Length Yoga Shorts (All-over Printing)",
        "S–2XL",
        9.17,
        ""
    ],
    [
        "Faux Cotton Short Sleeve T-Shirt",
        "S–5XL",
        5.23,
        ""
    ],
    [
        "Women Workout Yoga Pants with Lines",
        "S–2XL",
        8.74,
        ""
    ],
    [
        "Spaghetti Strap Dress (All-Over Printing)",
        "S–2XL",
        12.45,
        ""
    ],
    [
        "2-Piece Women's Tankini Swimsuit (Top Printed)",
        "S–6XL",
        13.46,
        ""
    ],
    [
        "Women's Long Sleeve Sun Protection Shirt-UPF 40 UV Rash Guard",
        "S–2XL",
        6.99,
        ""
    ],
    [
        "2-Piece Women's Tankini Set High Neck Halter Top",
        "XS–2XL",
        9.81,
        ""
    ],
    [
        "Plus Size Women's Halter Bikini Set",
        "XL–4XL",
        9.17,
        ""
    ],
    [
        "Women's One Piece Tummy Control V Neck Swimwear",
        "S–2XL",
        10.69,
        ""
    ],
    [
        "Plus Size Women Tankini 2-Piece Swimsuit (Top Printed)",
        "XL–5XL",
        12.60,
        ""
    ],
    [
        "Worn-effect Fabric Women Satin Pajama Set",
        "XS–5XL",
        11.96,
        ""
    ],
    [
        "Cooling Polyester Ruffle V-Neck T-Shirt",
        "S–5XL",
        6.24,
        "Premium"
    ],
    [
        "Cooling Short Sleeve Loungewear Set",
        "S–5XL",
        10.84,
        "Premium"
    ],
    [
        "Ice Silk V Neck Short-Sleeve Women Shirt",
        "S–5XL",
        5.10,
        ""
    ],
    [
        "Ice Silk Women Underwear Thongs",
        "S–2XL",
        4.03,
        ""
    ],
    [
        "2-Piece Bikini Swimwear (All-Over Printing)",
        "S–2XL",
        6.39,
        ""
    ],
    [
        "2-Piece Thong Triangle Bikini Set",
        "XS–2XL",
        7.46,
        ""
    ],
    [
        "Strapless Women Tube Top Y2K Bandeau",
        "S–2XL",
        4.03,
        ""
    ],
    [
        "Swimming Cap for Women and Men",
        "One size",
        3.17,
        ""
    ],
    [
        "Plus Size Two Piece Swimsuit with Tankini",
        "XL–4XL",
        15.60,
        ""
    ],
    [
        "Plus Size Round-neck Short Sleeve Dress",
        "L–4XL",
        8.27,
        ""
    ],
    [
        "Asymmetrical Hem Shirt (All-Over Printing)",
        "S–8XL",
        11.27,
        "Premium"
    ],
    [
        "Polar Fleece Double-Zip Jacket (All-Over Printing)",
        "S–6XL",
        22.67,
        "Premium"
    ],
    [
        "Long-Sleeve Raglan T-Shirt for Women",
        "S–6XL",
        9.84,
        "Premium"
    ],
    [
        "Loose-Fit 3/4 Sleeve Boat Neck T-Shirt",
        "S–5XL",
        7.67,
        "Premium"
    ],
    [
        "Round Neck 3/4 Sleeve Long Dress",
        "S–8XL",
        10.46,
        "Premium"
    ],
    [
        "Wide Round Neck 3/4 Sleeve Long Dress",
        "S–8XL",
        13.46,
        "Premium"
    ],
    ...
    [
        "Short Sleeve V Neck Lovely Dress",
        "2XS–6XL",
        10.78,
        "Premium"
    ],
    [
        "Tank Top Pocket Dress",
        "2XS–5XL",
        6.77,
        ""
    ],
    [
        "Slim Fit Spaghetti Strap Dress for Women",
        "XS–6XL",
        5.31,
        ""
    ],
    ...
    [
        "Cheerleader Set for Women",
        "S–4XL",
        8.27,
        ""
    ],
    [
        "Cheerleader Dress for Women",
        "XS–2XL",
        5.74,
        ""
    ],
    ...
    [
        "Cotton Summer Short Sleeve T-Shirts for Women",
        "2XS–4XL",
        9.99,
        ""
    ],
    [
        "Cotton Pajama Pants for Women",
        "S–5XL",
        11.27,
        ""
    ],
    [
        "Cotton Thong Underwear for Women",
        "S–2XL",
        5.49,
        ""
    ],
    [
        "Button-Down Polo Shirt for Women",
        "S–3XL",
        6.71,
        ""
    ],
    [
        "Workout Crop Yoga Tank Top",
        "S–2XL",
        8.53,
        ""
    ],
    [
        "Slit Fitted Camisole Cheongsam",
        "S–4XL",
        7.78,
        ""
    ],
    [
        "One Size Ice Silk Nightdress",
        "XL",
        6.39,
        ""
    ],
    ...
    [
        "Women's Baseball Jacket",
        "XS–5XL",
        9.34,
        ""
    ],
    [
        "Women's Ice Silk Top with Half-Sleeve",
        "S–6XL",
        6.17,
        "Premium"
    ],
    [
        "Women's Cool Touch Fitted Quick Dry Top",
        "S–6XL",
        10.89,
        "Premium"
    ],
    [
        "Women's Long Sleeve Quick Dry Top",
        "S–6XL",
        8.31,
        "Premium"
    ],
    ...
    [
        "V-neck Dress for Women",
        "S–3XL",
        7.41,
        ""
    ],
    [
        "Women's Sleeveless Polo Shirt",
        "XS–4XL",
        5.53,
        ""
    ],
    ...
    [
        "Women's Stand-Up Collar Fleece Jacket",
        "S–4XL",
        9.56,
        ""
    ],
    ...
    [
        "Stand-up Collar Fleece Casual Jacket",
        "S–6XL",
        27.39,
        "Premium"
    ],
    [
        "Winter Quilted Long-Sleeve Hooded Outerwear",
        "S–6XL",
        37.24,
        "Premium"
    ],
    [
        "Fleece Sweatshirt Short Jacket for Women",
        "S–6XL",
        13.46,
        "Premium"
    ],
    [
        "Double-Layer Hooded Top",
        "S–6XL",
        23.31,
        "Premium"
    ],
    [
        "Full-Edge Binding Slim-Fit Jacket",
        "S–6XL",
        16.46,
        "Premium"
    ],
    [
        "Double-Layered Hoodie with Pockets",
        "S–6XL",
        16.99,
        "Premium"
    ],
    ...
    [
        "260gsm Women's Cute Sweatshirt (Back Printing)",
        "S–3XL",
        8.96,
        ""
    ],
    ...
    [
        "Women's V Neck Long Sleeved Top",
        "S–5XL",
        6.60,
        ""
    ],
    [
        "Bikini Swimsuit (All-Over Printing)",
        "XS–2XL",
        8.64,
        ""
    ],
    [
        "Women's High-Rise Panties",
        "S–2XL",
        3.60,
        ""
    ],
    [
        "Straight-Leg Drawstring Yoga Pants",
        "S–2XL",
        7.20,
        ""
    ],
    [
        "Women's Ruffled Sweatshirt",
        "S–5XL",
        6.34,
        ""
    ],
    [
        "Women's Low-Rise Panties",
        "S–2XL",
        3.24,
        ""
    ],
    ...
    [
        "Women's Drop Shoulder Shirt",
        "S–3XL",
        8.06,
        ""
    ],
    [
        "Women's V Neck Ruffled Sleeve Top",
        "S–3XL",
        6.34,
        ""
    ],
    ...
    [
        "Mediterranean Style V Neck Mid-Sleeve Robe",
        "S–5XL",
        10.20,
        ""
    ],
    [
        "Mediterranean Style V-Neck Suit",
        "XS–5XL",
        11.10,
        ""
    ],
    [
        "Women's Mediterranean Style Set",
        "XS–5XL",
        15.13,
        ""
    ],
    [
        "Midi Spaghetti Strap Dress",
        "XS–5XL",
        6.60,
        ""
    ],
    [
        "Lace-Trimmed Camisole Nightgown",
        "S–4XL",
        6.28,
        ""
    ],
    [
        "Ice Silk Camisole Pajama Set",
        "XS–4XL",
        10.89,
        ""
    ],
    [
        "Ruffled Short-Sleeve Pajama Set",
        "S–5XL",
        9.60,
        ""
    ],
    [
        "Women's V-Neck Pajama Set",
        "S–5XL",
        11.96,
        ""
    ],
    [
        "V-Neck Short Sleeve Pajama Set",
        "S–5XL",
        9.99,
        ""
    ],
    [
        "Women's 3/4 Sleeve Top",
        "S–3XL",
        7.67,
        ""
    ],
    ...
    [
        "Women's Yoga Sports Tank",
        "S–6XL",
        9.60,
        "Premium"
    ],
    [
        "Short Sleeve Collared Shirt Dress",
        "XS–6XL",
        9.77,
        ""
    ],
    ...
    [
        "Women's Loose Fit Casual Pants",
        "S–5XL",
        8.91,
        ""
    ],
    ...
    [
        "Women's V Neck Short Sleeve T-Shirt",
        "S–2XL",
        4.41,
        ""
    ],
    [
        "Women's Backless Top",
        "XS–L",
        4.67,
        ""
    ],
    [
        "Women's Loungewear Pajama Set",
        "S–5XL",
        12.77,
        ""
    ],
    ...
    [
        "Long Sleeve Mesh T-Shirt",
        "S–5XL",
        5.42,
        ""
    ],
    [
        "Lace Trim V-Neck 3/4 Sleeve T-Shirt",
        "S–5XL",
        7.48,
        ""
    ],
    [
        "Chic Strapless Bandana Style Bikini",
        "XS–2XL",
        8.10,
        ""
    ],
    [
        "Women's V Neck Long Sleeve Hoodie",
        "S–3XL",
        7.20,
        ""
    ],
    ...
    [
        "Flannel Women's Sleep Pants",
        "S–5XL",
        7.89,
        ""
    ],
    [
        "Sheer Mesh One-Piece Swimsuit",
        "S–2XL",
        11.31,
        ""
    ],
    [
        "One Size Flannel Nightdress",
        "XL",
        7.63,
        ""
    ],
    ...
    [
        "Puff Short Sleeve Top",
        "2XS–3XL",
        6.99,
        ""
    ],
    [
        "Women's Lightweight Cardigan",
        "S–6XL",
        8.42,
        ""
    ],
    [
        "Women's Ruffle T-shirt",
        "XS–5XL",
        6.99,
        ""
    ],
    ...
    [
        "Double Layer V-Neck Top",
        "S–5XL",
        8.27,
        "Premium"
    ],
    [
        "Short Sleeve Nightdress",
        "S–3XL",
        5.53,
        ""
    ],
    [
        "Sleeveless Knit Sweater",
        "S–3XL",
        5.10,
        ""
    ],
    ...
    [
        "Women's Lace Trim Pajama Shorts",
        "S–5XL",
        7.20,
        ""
    ],
    [
        "Button Down Collar Dress",
        "S–6XL",
        12.41,
        "Premium"
    ],
    [
        "Women's Flare Sleeve Tee",
        "XS–5XL",
        5.10,
        ""
    ],
    [
        "Lace Trimmed Short Sleeve Nightgown",
        "S–5XL",
        9.81,
        ""
    ],
    [
        "Women's Ruffled Sleep Pants",
        "S–5XL",
        8.06,
        ""
    ],
    [
        "Women's Ruffled Cover Up Dress",
        "S–2XL",
        6.49,
        ""
    ],
    [
        "Women's V Neck Rugby Jersey",
        "XS–5XL",
        4.89,
        ""
    ],
    [
        "Ruffled Yoga Skort with Pockets",
        "XS–3XL",
        6.13,
        ""
    ],
    ...
    [
        "Women's Ruffled Sleeve One Piece Swimsuit",
        "S–2XL",
        9.17,
        ""
    ],
    [
        "Women's Halter Tie Vest",
        "XS–5XL",
        3.49,
        ""
    ],
    [
        "Mesh High Stretch Dress Cover Up",
        "S–5XL",
        7.74,
        ""
    ],
    ...
    [
        "High Waisted Quick Drying Shorts",
        "S–3XL",
        8.64,
        "Premium"
    ],
    [
        "Women's Cuban Collar Pajama Set",
        "S–2XL",
        13.20,
        ""
    ],
    ...
    [
        "Women's Ruffle Long Sleeve Robe",
        "S–5XL",
        9.34,
        ""
    ],
    [
        "Short Sleeved Wide Leg Pants Set",
        "S–5XL",
        8.74,
        ""
    ],
    [
        "Sleeveless Top and Wide Leg Pants Set",
        "S–5XL",
        9.71,
        ""
    ],
    [
        "Strap Top Wide Leg Pants Set",
        "S–5XL",
        8.74,
        ""
    ],
    ...
    [
        "Women's Button Up Vest",
        "S–3XL",
        4.89,
        ""
    ],
    [
        "High Neck Mesh Top For Women",
        "S–5XL",
        5.53,
        ""
    ],
    [
        "Casual V Neck Dress For Women",
        "S–3XL",
        9.99,
        ""
    ],
    [
        "Irregular Hemmed Skirt",
        "S–3XL",
        6.13,
        ""
    ],
    ...
    [
        "Flared Sleeve Dress For Women",
        "S–5XL",
        6.99,
        ""
    ],
    [
        "Mesh One Piece Swimsuit For Women",
        "S–2XL",
        12.81,
        ""
    ],
    [
        "Strap One Piece Swimsuit For Women",
        "S–2XL",
        12.81,
        ""
    ],
    [
        "Women's V Neck One Piece Swimsuit",
        "S–2XL",
        12.81,
        ""
    ],
    [
        "Bat Sleeve Dress For Women",
        "S–5XL",
        6.99,
        ""
    ],
    [
        "Women's Bubble Sleeve T-Shirt",
        "S–5XL",
        6.34,
        ""
    ],
    [
        "Women's Square Neck Long Sleeved Shirt",
        "XS–5XL",
        6.34,
        ""
    ],
    ...
    [
        "Square Collar Long Sleeved Jumpsuit",
        "XS–5XL",
        6.99,
        ""
    ],
    [
        "Women's Button Up Hoodie",
        "S–5XL",
        7.46,
        ""
    ],
    ...
    [
        "Netted Swimsuit Set For Women",
        "S–2XL",
        13.67,
        ""
    ],
    [
        "Sporty Bikini Swimwear Set",
        "S–2XL",
        9.39,
        ""
    ],
    [
        "Mesh Splicing One-Piece Swimsuit",
        "S–2XL",
        10.03,
        ""
    ],
    ...
    [
        "Casual Long Sleeve V-Neck Sweatshirt",
        "S–5XL",
        6.81,
        ""
    ],
    [
        "Women's Square Neckline Ruffle Dress",
        "S–5XL",
        8.98,
        "Premium"
    ],
    ...
    [
        "Cotton Women's Short Sleeved Shirt",
        "XS–5XL",
        11.10,
        ""
    ],
    [
        "Irregular Shirt For Women",
        "S–3XL",
        13.46,
        ""
    ],
    ...
    [
        "Women's Straight Wide Leg Pants",
        "S–5XL",
        8.91,
        ""
    ],
    [
        "Lantern Long Sleeve Shirt",
        "S–5XL",
        8.96,
        ""
    ],
    [
        "Women's Long Sleeve Cardigan With Pockets",
        "S–5XL",
        7.84,
        ""
    ],
    [
        "Ankle-length Slip Dress With Straps",
        "S–5XL",
        8.91,
        ""
    ],
    [
        "Short Sleeved Pajama Set",
        "S–3XL",
        8.91,
        ""
    ]
];
const partBProducts = partBRaw.map(([name, sizes, price, badge], i)=>{
    const cat = categorizePartB(name);
    const tags = extractProcessTags(name);
    return p({
        name,
        sizes,
        sizeList: parseSizes(sizes),
...
function categorizeBeauty(name, tags, badge) {
    const b = badge.toLowerCase();
    const n = name.toLowerCase();
    const t = tags.join(' ').toLowerCase();
    if (b.includes('collection box')) return 'Collection Boxes';
    if (/lipstick|mascara|foundation|concealer|color correcting/.test(n)) return 'Makeup';
    if (/body cream|body wash|body scrub|body serum|body oil|body exfoliator|body & body|hand cream|hand & body|hand.*body.*wash|deodorant|roll-on|candle\b|baby |soy wax|body lotion|body care|body cleanser/.test(n)) return 'Body Care';
    if (n.includes('body') && /scrub|exfoliator|wash|cream|oil|serum|lotion/.test(n)) return 'Body Care';
    if (n.includes('face & body') && /scrub|exfoliator/.test(n)) return 'Body Care';
    if (/keratin|lack of volume|lack of glow|rosemary|dry ends/.test(t)) return 'Hair Care';
    if (/shampoo|conditioner|hair mist|scalp|beard|dry shampoo|leave-in/.test(n)) return 'Hair Care';
    return 'Face Care';
}
function parseBeautyPrice(raw) {
    // Handle formats like "$7.05 (was $14.10)" or "$16.35" or "$10.80 (was $12.50)"
    const mainMatch = raw.match(/\$([\d.]+)/);
    const origMatch = raw.match(/(?:was|was \$)\s*\$([\d.]+)/);
    if (!mainMatch) return {
        price: 0
    };
    return {
        price: parseFloat(mainMatch[1]),
        originalPrice: origMatch ? parseFloat(origMatch[1]) : undefined
    };
}
const beautyRows = [
    [
        "Anti-Age Hydrogel Eye Patches",
        "Anti-age, Niacinamide (B3)",
        "7 Pcs",
        "$16.35",
        "New, Coming Soon"
    ],
    [
        "Caffeine + Vitamin C Energizing Hydrogel Eye Patches",
        "Vitamin C, Under-eye fatigue",
        "7 Pcs",
        "$16.35",
        "New, Coming Soon"
    ],
    [
        "Anti-Fatigue Hydrogel Eye Patches",
        "Panthenol, Under-eye fatigue",
        "7 Pcs",
        "$16.35",
        "New, Coming Soon"
    ],
    [
        "Hyaluronic Hydrogel Lip Mask",
        "Dehydrated skin, Panthenol",
        "7 Pcs",
        "$20.70",
        "New, Coming Soon"
    ],
    [
        "Anti-Age Peptide Collection",
        "Anti-age, Dehydrated skin",
        "3 products",
        "$48.30",
        "New, Collection Box"
    ],
    [
        "Quick Refresh Dry Shampoo Spray",
        "Propanediol, Lack of volume",
        "100 ml",
        "$11.60",
        "New, Coming Soon"
    ],
    [
        ...
        "Odor protection, Panthenol",
        "50 ml",
        "$12.60",
        "1 Variant"
    ],
    [
        "Peptide Age-Defying Eye Cream",
        "Anti-age, Vitamin C",
        "15 ml",
        "$9.10",
        "New"
    ...
    [
        "Exosome & Niacinamide Serum",
        "Anti-age, Lactic Acid",
        "30 ml",
        "$14.20",
        "New"
    ],
    [
        ...
        "Peptides, Lack of volume",
        "6 ml",
        "$13.30",
        "New"
    ],
    [
        "Matte Lipstick, Dusty Rose",
        "Dehydrated skin, Shea Butter",
        "4 g",
        "$16.20",
        "New, 1 Variant"
    ],
    ...
    [
        "Foundation with Peptides, 05 Fair Neutral",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Color Correcting Ceramide Stick, 25 Medium",
        "Damaged skin barrier, Ceramides",
        "12 g",
        "$13.70",
        "New, 3 Variants"
    ],
    [
        "Color Correcting Ceramide Stick, 35 Deep",
        "Damaged skin barrier, Ceramides",
        "12 g",
        "$13.70",
        "New, 3 Variants"
    ...
    [
        "Correcting Concealer, 10 Light Warm",
        "Hyaluronic Acid, Sensitive skin",
        "4 ml",
        "$13.50",
        "New, 6 Variants"
    ],
    [
        "Correcting Concealer, 20 Medium Warm",
        "Hyaluronic Acid, Sensitive skin",
        "4 ml",
        "$13.50",
        "New, 6 Variants"
    ...
    [
        "Scalp Care Exfoliating Serum",
        "Sodium Hyaluronate, Lack of volume",
        "30 ml",
        "$13.30",
        ""
    ],
    [
        "Color Correcting Ceramide Stick, 20 Light",
        "Damaged skin barrier, Ceramides",
        "12 g",
        "$13.70",
        "New, 3 Variants"
    ...
    [
        "Color Correcting Ceramide Stick, 30 Tan",
        "Damaged skin barrier, Ceramides",
        "12 g",
        "$13.70",
        "New, 3 Variants"
    ...
    [
        "Correcting Concealer, 30 Tan Neutral",
        "Hyaluronic Acid, Sensitive skin",
        "4 ml",
        "$13.50",
        "New, 6 Variants"
    ...
    [
        "Correcting Concealer, 35 Deep Neutral",
        "Hyaluronic Acid, Sensitive skin",
        "4 ml",
        "$13.50",
        "New, 6 Variants"
    ...
    [
        "Foundation with Peptides, 10 Light Warm",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Foundation with Peptides, 15 Light Cool",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Foundation with Peptides, 20 Medium Neutral",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Foundation with Peptides, 25 Medium Warm",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Foundation with Peptides, 30 Tan Neutral",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Foundation with Peptides, 35 Tan Warm",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Foundation with Peptides, 45 Deep Warm",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Foundation with Peptides, 50 Deep Cool",
        "Peptides, Dark spots",
        "30 ml",
        "$16.40",
        "New, 9 Variants"
    ...
    [
        "Correcting Concealer, 25 Medium Neutral",
        "Hyaluronic Acid, Sensitive skin",
        "4 ml",
        "$13.50",
        "New, 6 Variants"
    ...
    [
        "Correcting Concealer, 05 Light Cool",
        "Hyaluronic Acid, Sensitive skin",
        "4 ml",
        "$13.50",
        "New, 6 Variants"
    ...
    [
        "Correcting Concealer, 15 Medium Cool",
        "Hyaluronic Acid, Sensitive skin",
        "4 ml",
        "$13.50",
        "New, 6 Variants"
    ...
    [
        ...
        "Blemishes, Aloe Juice",
        "90 ml",
        "$15.80",
        "New"
    ],
    [
        "Omega 6-9 Glowing Skin Body Oil",
        "Vitamin E, Dehydrated skin",
        "150 ml",
        "$18.20",
        ""
    ],
    [
        "Sensitive Skin Overnight Cream, Fragrance-Free",
        "Algae, Sensitive skin",
        "50 ml",
        "$14.90",
        ""
    ],
    ...
    [
        "Icelandic Volcano Face & Body Scrub",
        "Volcanic sand, Cleansing",
        "170 ml",
        "$15.20",
        "Trending"
    ],
    [
        ...
        "Prebiotics, Damaged skin barrier",
        "100 ml",
        "$12.70",
        ""
    ],
    ...
    [
        ...
        "Dehydrated skin, Cocoa Butter",
        "190 ml",
        "$14.90",
        ""
    ],
    [
        "Clear Complexion Collection Box",
        "Anti-age, Blemishes",
        "3 products",
        "$38.00",
        "Collection Box"
    ...
    [
        ...
        "Urea, Dehydrated skin",
        "280 ml",
        "$16.40",
        "Trending, 1 Variant"
    ],
    [
        "Timeless Radiance Collection Box",
        "Anti-age, Dehydrated skin",
        "3 products",
        "$42.80",
        "Collection Box"
    ...
    [
        "Sensitive Skin Moisturiser, Fragrance Free",
        "Dehydrated skin, Hyaluronic Acid",
        "50 ml",
        "$14.10",
        ""
    ...
    [
        "Rejuvenating Glow Collection Box",
        "Dark spots, Dehydrated skin",
        "3 products",
        "$42.80",
        "Collection Box"
    ],
    ...
    [
        "The Age-Defying Trio Collection Box",
        "Anti-age, Dehydrated skin",
        "3 products",
        "$51.40",
        "Collection Box"
    ...
    [
        "Glowy Skin Trio Collection Box",
        "Anti-age, Dehydrated skin",
        "3 products",
        "$42.80",
        "Collection Box"
    ...
    [
        "The Ultimate Renewal Collection Box",
        "Anti-age, Dark spots",
        "3 products",
        "$45.30",
        "Collection Box"
    ...
    [
        "Hydration Ritual Collection Box",
        "Dehydrated skin",
        "3 products",
        "$45.30",
        "Collection Box"
    ...
    [
        "BiPhasic Make-up Remover, Fragrance Free",
        "Cleansing, Hyaluronic Acid",
        "100 ml",
        "$15.40",
        ""
    ],
    [
        "Anti-Aging Collection Box",
        "Anti-age, Dehydrated skin",
        "3 products",
        "$47.70",
        "Collection Box, Trending"
    ],
    [
    ...
    [
        "Silk Skin Body Serum, Woody Amber & Leather",
        "Dehydrated skin, Hyaluronic Acid",
        "270 ml",
        "$8.19 (was $11.70)",
        "-30%"
    ...
    [
        "Silk Skin Body Serum, Spices & Sandalwood",
        "Dehydrated skin, Cocoa Butter",
        "270 ml",
        "$8.47 (was $12.10)",
        "-30%"
    ...
    [
        "Silk Skin Hand Cream, Spices & Sandalwood",
        "Dehydrated skin, Cocoa Butter",
        "270 ml",
        "$8.89 (was $12.70)",
        "-30%"
    ...
    [
        "Silk Skin Hand Cream, Woody Amber & Leather",
        "Dehydrated skin, Cocoa Butter",
        "270 ml",
        "$8.89 (was $12.70)",
        "-30%"
    ...
    [
        ...
        "Cleansing, Dehydrated skin",
        "150 ml",
        "$16.60",
        ""
    ],
    [
        "Gloss Conditioner, Smoky Green Vetiver",
        "Dry ends, Panthenol",
        "370 ml",
        "$8.47 (was $12.10)",
        "-30%, Trending"
    ...
    [
        "Gloss Shampoo, Smoky Green Vetiver",
        "Lack of glow, Betaine",
        "400 ml",
        "$8.47 (was $12.10)",
        "-30%, Trending"
    ],
    ...
    [
        "Colour Care Shampoo, Peachy Grapefruit Zest",
        "Colour care, Aloe Juice",
        "400 ml",
        "$8.47 (was $12.10)",
        "-30%"
    ],
    [
        "Hand & Body Wash, Grapefruit",
        "Cleansing, Betaine",
        "490 ml",
        "$10.20",
        "1 Variant"
    ...
    [
        ...
        "Anti-age, Retinol Alternative",
        "30 ml",
        "$16.20",
        "Trending, 1 Variant"
    ],
    [
        "Hand & Body Wash, Peppermint & Dark Cedar",
        "Cleansing, Betaine",
        "490 ml",
        "$8.00 (was $10.00)",
        "-20%, 1 Variant"
    ...
    [
        "Hand & Body Wash, Ginger & Smoky Cardamom",
        "Cleansing, Betaine",
        "490 ml",
        "$7.50 (was $10.00)",
        "-25%, Trending, 1 Variant"
    ],
    [
        "Hand & Body Wash, Patchouli & Amber Vanilla",
        "Cleansing, Betaine",
        "490 ml",
        "$8.50 (was $10.00)",
        "-15%, 1 Variant"
...
const partCProducts = beautyRows.map(([name, rawTags, size, rawPrice, badge], i)=>{
    const tags = rawTags.split(',').map((t)=>t.trim()).filter(Boolean);
    const { price, originalPrice } = parseBeautyPrice(rawPrice);
    const category = categorizeBeauty(name, tags, badge);
    return p({
        name,
        tags,
        beautySize: size,
...
const partDProducts = bagRows.map(([name, material, dimensions, badge], i)=>p({
        name,
        material,
        dimensions,
        badges: parseBadges(badge),
...
for (const product of ALL_PRODUCTS){
    _slugIndex.set(product.slug, product);
    _idIndex.set(product.id, product);
}
function getAllProducts() {
    return ALL_PRODUCTS;
}
function getProductsByDepartment(dept) {
    return ALL_PRODUCTS.filter((p)=>p.department === dept);
}
function getProductsByCategory(dept, category) {
    return ALL_PRODUCTS.filter((p)=>p.department === dept && p.category === category);
}
function getCategoriesForDepartment(dept) {
    const products = getProductsByDepartment(dept);
    const catMap = new Map();
    for (const pr of products){
        if (!catMap.has(pr.category)) catMap.set(pr.category, new Set());
        if (pr.subcategory) catMap.get(pr.category).add(pr.subcategory);
    }
    return Array.from(catMap.entries()).map(([category, subs])=>({
            category,
...
function getDepartments() {
    ...
    for (const pr of ALL_PRODUCTS){
        deptCounts.set(pr.department, (deptCounts.get(pr.department) || 0) + 1);
    }
    return Object.keys(labels).map((dept)=>({
            dept: dept,
            label: labels[dept],
...
function getAllBadges() {
    const set = new Set();
    for (const pr of ALL_PRODUCTS){
        for (const b of pr.badges)set.add(b);
    }
...
function getAllTags() {
    ...
    for (const pr of ALL_PRODUCTS){
        if (pr.tags) {
            for (const t of pr.tags)set.add(t);
        }
    }
    return Array.from(set).sort();
}
...
"[project]/src/lib/commerce-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useCommerceStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>{
...
_s(useRouter, "tJ8z3LPY2MAH18F8bfTseUV3x10=", false, function() {
    return [
...
function ToastContainer() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ToastContainer.useEffect": ()=>{
            toastFn = ({
                "ToastContainer.useEffect": (type, message)=>{
                    ...
                    setTimeout({
                        "ToastContainer.useEffect": ()=>setToasts({
                                "ToastContainer.useEffect": (prev)=>prev.filter({
                                        "ToastContainer.useEffect": (t)=>t.id !== id
                                    }["ToastContainer.useEffect"])
                            }["ToastContainer.useEffect"])
                    }["ToastContainer.useEffect"], 4000);
                }
            })["ToastContainer.useEffect"];
            return ({
                "ToastContainer.useEffect": ()=>{
...
"[project]/src/portal/pages/PortalProductDetailPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/product-catalog.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$commerce$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/commerce-store.ts [app-client] (ecmascript)");
...
function PortalProductDetailPage({ productId: propProductId }) {
    _s();
    const { path } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$router$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { addToCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$commerce$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCommerceStore"])();
    // Extract product ID from URL if not passed as prop
    const productId = propProductId ?? path.split('/portal/shop/')[1]?.split('/')[0] ?? '';
    const product = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductById"])(productId);
    ...
    const [sizeGuideOpen, setSizeGuideOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const relatedProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPublishedProducts"])().filter((p)=>p.productFamily === product.productFamily && p.id !== product.id).slice(0, 4);
    const handleAddToCart = ()=>{
        addToCart(product, currentSize, currentColor, 1);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('success', `Added ${product.name} to cart`);
    };
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: product.images.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            product.badges.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                        color: "gray",
                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FAMILY_LABELS"][product.productFamily]
                                    }, void 0, false, {
                                        fileName: "[project]/src/portal/pages/PortalProductDetailPage.tsx",
                                        lineNumber: 130,
                                        columnNumber: 13
                            ...
                            product.fabric && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            product.dimensions && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm text-neutral-500 mb-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "font-medium text-neutral-700",
                            ...
                            product.concernTags && product.concernTags.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mb-4",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCents"])(product.retailPriceCents)
                                    }, void 0, false, {
                                        fileName: "[project]/src/portal/pages/PortalProductDetailPage.tsx",
                                        lineNumber: 162,
                                        columnNumber: 13
                                    }, this),
                                    product.wholesalePriceCents > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-sm text-neutral-400 ml-2",
                                        children: [
                                            "Wholesale: ",
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCents"])(product.wholesalePriceCents)
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/portal/pages/PortalProductDetailPage.tsx",
                                        lineNumber: 164,
                            ...
                            product.availableSizes.length > 0 && product.productFamily !== 'Beauty' && product.productFamily !== 'Bags' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mb-4",
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex flex-wrap gap-1.5",
                                        children: product.availableSizes.map((size)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    hasSizeGuide && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    sizeGuideOpen && hasSizeGuide && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        children: [
                                                            ...
                                                            Object.keys(product.sizeGuide[Object.keys(product.sizeGuide)[0]] ?? {}).map((measurement)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    ...
                                                    children: Object.entries(product.sizeGuide).map(([size, measurements])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            ...
                                                            children: [
                                                                ...
                                                                Object.entries(measurements).map(([key, value])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                            ...
                            product.availableColors.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mb-4",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                        className: "text-xs font-semibold text-neutral-900 mb-2 block",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex flex-wrap gap-1.5",
                                        children: product.availableColors.map((color)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: [
                                    ...
                                    " Add to Cart · ",
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCents"])(product.retailPriceCents)
                                ]
                            }, void 0, true, {
                                fileName: "[project]/src/portal/pages/PortalProductDetailPage.tsx",
                                lineNumber: 258,
            ...
            relatedProducts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "mt-12",
                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCents"])(p.retailPriceCents)
                                            }, void 0, false, {
                                                fileName: "[project]/src/portal/pages/PortalProductDetailPage.tsx",
                                                lineNumber: 285,
                                                columnNumber: 19
...
_s(PortalProductDetailPage, "UjpjADYkYm3kiqfaxi6SPGE/dwQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$router$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$commerce$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCommerceStore"]
    ];
});
_c = PortalProductDetailPage;
var _c;
__turbopack_context__.k.register(_c, "PortalProductDetailPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/adea/ShopBanner.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = ShopBanner;
var _c;
__turbopack_context__.k.register(_c, "ShopBanner");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/adea/ShopAllView.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shop$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/shop-catalog.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shopping$2d$bag$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShoppingBag$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/shopping-bag.js [app-client] (ecmascript) <export default as ShoppingBag>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$down$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronDown$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/chevron-down.js [app-client] (ecmascript) <export default as ChevronDown>");
...
/* ═══════════════════════════════════════════════════
   CATEGORY BANNER
   ═══════════════════════════════════════════════════ */ function CategoryBanner({ department, category, subcategory, count }) {
    const label = subcategory || category || department || "Shop All";
    const subtitle = subcategory ? `${category} — ${subcategory}` : category ? `${department} — ${category}` : department ? department : "All Products";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative overflow-hidden bg-black text-white px-6 py-10 md:px-12 md:py-14 mb-10",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "text-display text-[clamp(1.8rem,4vw,3.5rem)] leading-[0.9] uppercase",
                        children: label
                    }, void 0, false, {
                        fileName: "[project]/src/components/adea/ShopAllView.tsx",
                        lineNumber: 62,
...
/* ═══════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════ */ function FilterPill({ label, count, active, onClick }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        onClick: onClick,
        className: `flex items-center gap-2 px-5 py-2 text-[11px] uppercase tracking-[0.15em] border transition-all cursor-pointer whitespace-nowrap ${active ? "border-black bg-black text-white" : "border-black/15 text-black/60 hover:border-black/40 hover:text-black"}`,
        children: [
            label,
            count !== undefined && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: `text-[9px] ${active ? "text-white/50" : "text-black/30"}`,
                children: count
            }, void 0, false, {
                fileName: "[project]/src/components/adea/ShopAllView.tsx",
                lineNumber: 104,
   ...
   ═══════════════════════════════════════════════════ */ function SortSelect({ value, onChange }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$down$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronDown$3e$__["ChevronDown"], {
                className: "absolute right-2.5 top-1/2 -translate-y-1/2 h-3 w-3 pointer-events-none text-black/40"
            }, void 0, false, {
                fileName: "[project]/src/components/adea/ShopAllView.tsx",
                lineNumber: 136,
                columnNumber: 7
...
/* ═══════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════ */ function ProductCard({ product }) {
    ...
    const displayOriginal = product.originalPrice ? `$${product.originalPrice.toFixed(2)}` : null;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    hasImage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shopping$2d$bag$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShoppingBag$3e$__["ShoppingBag"], {
                            className: "h-8 w-8 text-black/8"
                        }, void 0, false, {
                            fileName: "[project]/src/components/adea/ShopAllView.tsx",
                            lineNumber: 169,
                            columnNumber: 13
                    ...
                    product.badges.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: product.badges.map((badge)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: `px-2 py-0.5 text-[8px] font-medium uppercase tracking-wider ${badge === "NEW" ? "bg-black text-white" : badge === "BESTSELLER" ? "bg-black text-white" : badge === "TRENDING" ? "bg-black text-white" : badge.includes("%") ? "bg-red-600 text-white" : "bg-black/70 text-white"}`,
                                children: badge
                            }, badge, false, {
                                fileName: "[project]/src/components/adea/ShopAllView.tsx",
                                lineNumber: 178,
                    ...
                    product.colorCount && product.colorCount > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute right-2 top-2 flex items-center gap-1 px-2 py-1 bg-white/90 backdrop-blur-sm",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "text-[9px] text-black/50",
                            children: [
                                product.colorCount,
                                " colors"
                            ]
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-[11px] font-medium uppercase tracking-wide text-black/80 leading-tight line-clamp-2",
                        children: product.name
                    }, void 0, false, {
                        fileName: "[project]/src/components/adea/ShopAllView.tsx",
                        lineNumber: 207,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            displayPrice && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            displayOriginal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "text-[11px] text-black/30 line-through",
                            ...
                            !hasPrice && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    product.sku && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-0.5 text-[9px] text-neutral-300 font-mono tracking-wider",
                    ...
                    product.beautySize && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-0.5 text-[10px] text-black/40",
                        children: product.beautySize
                    }, void 0, false, {
                        fileName: "[project]/src/components/adea/ShopAllView.tsx",
                        lineNumber: 229,
                        columnNumber: 11
                    ...
                    product.fabric && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-0.5 text-[9px] text-black/30",
...
/* ═══════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════ */ function ActiveFilters({ department, category, subcategory, badge, onClear }) {
    const filters = [];
    if (department) filters.push({
        key: "department",
        label: department
    });
...
function ShopAllView() {
    _s1();
    const [activeDept, setActiveDept] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [activeSub, setActiveSub] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [activeBadge, setActiveBadge] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShopAllView.useEffect": ()=>{
            fetch('/api/shop/admin-products').then({
                "ShopAllView.useEffect": (r)=>r.json()
            }["ShopAllView.useEffect"]).then({
                "ShopAllView.useEffect": (res)=>{
                    if (res.success) setAdminProducts(res.data);
                }
            }["ShopAllView.useEffect"]).catch({
                "ShopAllView.useEffect": ()=>{}
            }["ShopAllView.useEffect"]); // silent fail — admin products are additive
        }
    }["ShopAllView.useEffect"], []);
    ...
    const allProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ShopAllView.useMemo[allProducts]": ()=>{
            return [
                ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shop$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllProducts"])(),
                ...adminProducts
            ];
        }
    }["ShopAllView.useMemo[allProducts]"], [
    ...
    const departments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ShopAllView.useMemo[departments]": ()=>{
            const staticDepts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shop$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDepartments"])();
            const deptCounts = new Map();
            ...
            return Object.entries(labels).map({
                "ShopAllView.useMemo[departments]": ([dept, label])=>({
                        dept: dept,
                        label,
                        count: deptCounts.get(dept) || 0
                    })
            }["ShopAllView.useMemo[departments]"]).filter({
                "ShopAllView.useMemo[departments]": (d)=>d.count > 0
            }["ShopAllView.useMemo[departments]"]).sort({
                "ShopAllView.useMemo[departments]": (a, b)=>b.count - a.count
            }["ShopAllView.useMemo[departments]"]);
        }
    }["ShopAllView.useMemo[departments]"], [
        adminProducts
    ...
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ShopAllView.useMemo[categories]": ()=>{
            if (!activeDept) return [];
            // Build from static + admin products
            const catMap = new Map();
            // Static categories
            const staticCats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shop$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategoriesForDepartment"])(activeDept);
            ...
            for (const [category, subs] of catMap){
                const count = allProducts.filter({
                    "ShopAllView.useMemo[categories]": (p)=>p.department === activeDept && p.category === category
                }["ShopAllView.useMemo[categories]"]).length;
                result.push({
                    category,
            ...
            return result.sort({
                "ShopAllView.useMemo[categories]": (a, b)=>b.count - a.count
            }["ShopAllView.useMemo[categories]"]);
        }
    }["ShopAllView.useMemo[categories]"], [
        activeDept,
    ...
    const availableBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ShopAllView.useMemo[availableBadges]": ()=>{
            let items = activeDept ? allProducts.filter({
                "ShopAllView.useMemo[availableBadges]": (p)=>p.department === activeDept
            }["ShopAllView.useMemo[availableBadges]"]) : allProducts;
            if (activeCategory) items = items.filter({
                "ShopAllView.useMemo[availableBadges]": (p)=>p.category === activeCategory
            }["ShopAllView.useMemo[availableBadges]"]);
            if (activeSub) items = items.filter({
                "ShopAllView.useMemo[availableBadges]": (p)=>p.subcategory === activeSub
            }["ShopAllView.useMemo[availableBadges]"]);
            const set = new Set();
    ...
    const products = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ShopAllView.useMemo[products]": ()=>{
            let items = activeDept ? allProducts.filter({
                "ShopAllView.useMemo[products]": (p)=>p.department === activeDept
            }["ShopAllView.useMemo[products]"]) : [
                ...allProducts
            ];
            if (activeCategory) items = items.filter({
                "ShopAllView.useMemo[products]": (p)=>p.category === activeCategory
            }["ShopAllView.useMemo[products]"]);
            if (activeSub) items = items.filter({
                "ShopAllView.useMemo[products]": (p)=>p.subcategory === activeSub
            }["ShopAllView.useMemo[products]"]);
            if (activeBadge) items = items.filter({
                "ShopAllView.useMemo[products]": (p)=>p.badges.includes(activeBadge)
            }["ShopAllView.useMemo[products]"]);
            switch(sort){
                case "price-asc":
                    items = [
                        ...
                        "ShopAllView.useMemo[products]": (a, b)=>a.price - b.price
                    }["ShopAllView.useMemo[products]"]);
                    break;
                case "price-desc":
                    items = [
                        ...
                        "ShopAllView.useMemo[products]": (a, b)=>b.price - a.price
                    }["ShopAllView.useMemo[products]"]);
                    break;
                case "name-asc":
                    items = [
                        ...
                        "ShopAllView.useMemo[products]": (a, b)=>a.name.localeCompare(b.name)
                    }["ShopAllView.useMemo[products]"]);
                    break;
                case "name-desc":
                    items = [
                        ...
                        "ShopAllView.useMemo[products]": (a, b)=>b.name.localeCompare(a.name)
                    }["ShopAllView.useMemo[products]"]);
                    break;
                default:
                    items = [
                        ...
                        "ShopAllView.useMemo[products]": (a, b)=>a.sortOrder - b.sortOrder
                    }["ShopAllView.useMemo[products]"]);
            }
            return items;
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "mt-8",
        children: [
            (activeDept || activeCategory || activeSub) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CategoryBanner, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    departments.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FilterPill, {
                            label: d.label,
                            count: d.count,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SortSelect, {
                            value: sort,
                            onChange: setSort
                        }, void 0, false, {
                            fileName: "[project]/src/components/adea/ShopAllView.tsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    categories.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-wrap items-center gap-2 mb-4",
                        children: categories.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FilterPill, {
                                label: c.category,
                                count: c.count,
                    ...
                    currentCategoryData && currentCategoryData.subcategories.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-wrap items-center gap-2 mb-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FilterPill, {
                                label: "All",
                    ...
                    availableBadges.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-wrap items-center gap-2 mb-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "text-[10px] uppercase tracking-[0.2em] text-black/30 pr-2",
                                children: "Tags:"
                            }, void 0, false, {
                                fileName: "[project]/src/components/adea/ShopAllView.tsx",
                                lineNumber: 553,
                            ...
                            availableBadges.slice(0, 8).map((badge)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FilterPill, {
                                    label: badge,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActiveFilters, {
                department: activeDept,
                category: activeCategory,
                subcategory: activeSub,
                badge: activeBadge,
            ...
            products.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-2 gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 lg:gap-x-5",
                children: products.map((prod)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProductCard, {
                        product: prod
                    }, prod.id, false, {
                        fileName: "[project]/src/components/adea/ShopAllView.tsx",
                        lineNumber: 597,
...
_s1(ShopAllView, "xKiAVipcOQGPe7QLKiV2BRm3axM=");
_c5 = ShopAllView;
var _c, _c1, _c2, _c3, _c4, _c5;
__turbopack_context__.k.register(_c, "CategoryBanner");
__turbopack_context__.k.register(_c1, "FilterPill");
__turbopack_context__.k.register(_c2, "SortSelect");
__turbopack_context__.k.register(_c3, "ProductCard");
__turbopack_context__.k.register(_c4, "ActiveFilters");
__turbopack_context__.k.register(_c5, "ShopAllView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/components/adea/Shop.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/product-catalog.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shop$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/shop-catalog.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$portal$2f$pages$2f$PortalProductDetailPage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/portal/pages/PortalProductDetailPage.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$adea$2f$ShopBanner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/adea/ShopBanner.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$adea$2f$ShopAllView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/adea/ShopAllView.tsx [app-client] (ecmascript)");
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: SCROLL_PLATFORMS.map((p, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                        href: "#",
                                        onClick: (e)=>e.preventDefault(),
                                        className: "flex shrink-0 items-center gap-3 px-6 py-3 hover:bg-white/5 transition-colors cursor-pointer",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$adea$2f$SiteChrome$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlatformIcon"], {
                                                name: p.key,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    available && onQuickAdd && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: (e)=>{
                            e.stopPropagation();
                            onQuickAdd();
                        },
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    product.colors.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: product.colors.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
/* ═══════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════ */ function CategorySidebar({ selected, onChange, onNavigate }) {
    _s();
    const [openNodes, setOpenNodes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    const toggle = (slug)=>{
        setOpenNodes((prev)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORY_TREE"].map((node)=>renderNode(node, 0))
        ]
    }, void 0, true, {
        fileName: "[project]/src/components/adea/Shop.tsx",
        lineNumber: 200,
...
_s(CategorySidebar, "E2lVwfAVaD93nH37yh4pH2MCrw4=");
_c2 = CategorySidebar;
/* ═══════════════════════════════════════════════════
   SIZE FILTER
   ═══════════════════════════════════════ */ const SIZE_LABELS = {
...
function SizeFilter({ categories, selected, onChange }) {
    ...
    if (categories) {
        const types = new Set(categories.map((c)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORY_SIZE_TYPE"][c] ?? "none"));
        if (types.size === 1) activeSizeType = [
            ...types
        ][0];
        else activeSizeType = "clothing";
    }
    const options = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SIZE_OPTIONS"][activeSizeType];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: options.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: [
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SHOP_ALBUMS"].length,
                    " albums"
                ]
            }, void 0, true, {
                fileName: "[project]/src/components/adea/Shop.tsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SHOP_ALBUMS"].map((album)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "group cursor-pointer",
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "relative aspect-square overflow-hidden bg-[#f0f0f0]",
                                children: [
                                    album.cover ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                        src: album.cover,
                                        alt: album.title,
...
/* ─── Shop All View ─── */ function ShopAllView({ onSelectProduct, onQuickAdd }) {
    _s1();
    const [selectedCats, setSelectedCats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ShopAllView.useMemo[filtered]": ()=>{
            let list = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALL_PRODUCTS"];
            if (selectedCats) list = list.filter({
                "ShopAllView.useMemo[filtered]": (p)=>selectedCats.includes(p.category)
            }["ShopAllView.useMemo[filtered]"]);
            if (selectedSize) list = list.filter({
                "ShopAllView.useMemo[filtered]": (p)=>p.sizes.includes(selectedSize)
            }["ShopAllView.useMemo[filtered]"]);
            return list;
        }
    }["ShopAllView.useMemo[filtered]"], [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CategorySidebar, {
...
_s1(ShopAllView, "672g2Am2kD3xHyKhwr7PcMjZWb4=");
_c7 = ShopAllView;
function ShopPage() {
    _s2();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { addToCart, cartCount, shopSubPath } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    const [shopPath, setShopPath] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(shopSubPath || "albums");
    ...
    const openAlbum = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShopPage.useCallback[openAlbum]": (album)=>{
            router.push(`/shop/${album.slug}`);
        }
    }["ShopPage.useCallback[openAlbum]"], [
        router
    ]);
    const openProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShopPage.useCallback[openProduct]": (p)=>{
            router.push(`/shop/${p.slug}`);
        }
    }["ShopPage.useCallback[openProduct]"], [
        router
    ]);
    const handleQuickAdd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShopPage.useCallback[handleQuickAdd]": ()=>{
            addToCart();
        }
    }["ShopPage.useCallback[handleQuickAdd]"], [
        addToCart
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$adea$2f$ShopBanner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShopBanner"], {}, void 0, false, {
                fileName: "[project]/src/components/adea/Shop.tsx",
                lineNumber: 393,
                columnNumber: 7
            }, this),
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-12",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ShopNav, {
                                    active: shopPath,
                                ...
                                shopPath === "albums" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AlbumsView, {
                                ...
                                shopPath === "collections" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CollectionsView, {
                                    selectedCats: null,
                                    onCategoryChange: ()=>{}
                                }, void 0, false, {
                                    fileName: "[project]/src/components/adea/Shop.tsx",
                                ...
                                shopPath === "shop-all" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$adea$2f$ShopAllView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShopAllView"], {}, void 0, false, {
                                    fileName: "[project]/src/components/adea/Shop.tsx",
                                    lineNumber: 402,
                                    columnNumber: 41
                                }, this)
...
_s2(ShopPage, "k3XZRCxT/CIchVizoPx/QxmkvrU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
...
/* ═══════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════ */ function AlbumActionList({ album, onStream, onAddToCart }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: actions.map((action, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
function AlbumDetailPage({ slug }) {
    _s3();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { detailSlug, setDetailSlug, addToCart, setActiveTab, setShopSubPath } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    const [streamOpen, setStreamOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [streamTitle, setStreamTitle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [sidebarCats, setSidebarCats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const activeSlug = slug || detailSlug;
    const album = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AlbumDetailPage.useMemo[album]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SHOP_ALBUMS"].find({
                "AlbumDetailPage.useMemo[album]": (a)=>a.slug === activeSlug
            }["AlbumDetailPage.useMemo[album]"])
    }["AlbumDetailPage.useMemo[album]"], [
        activeSlug
    ]);
    const openProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AlbumDetailPage.useCallback[openProduct]": (p)=>{
            router.push(`/shop/${p.slug}`);
        }
    }["AlbumDetailPage.useCallback[openProduct]"], [
        router
    ]);
    const handleQuickAdd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AlbumDetailPage.useCallback[handleQuickAdd]": ()=>{
            addToCart();
        }
    }["AlbumDetailPage.useCallback[handleQuickAdd]"], [
        addToCart
    ...
    const openStream = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AlbumDetailPage.useCallback[openStream]": (title)=>{
            setStreamTitle(title);
            setStreamOpen(true);
        }
    }["AlbumDetailPage.useCallback[openStream]"], []);
    if (!album) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CategorySidebar, {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: album.cover ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                    src: album.cover,
                                                    alt: album.title,
                                                    className: "h-full w-full object-cover"
                                                }, void 0, false, {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        album.quote && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AlbumActionList, {
                                                album: album,
                                                onStream: openStream,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: album.merch.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProductCard, {
                                            product: p,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StreamingOverlay, {
                open: streamOpen,
...
_s3(AlbumDetailPage, "hvLddMwB6euZPn8qE3ecddpiIGc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
_c10 = AlbumDetailPage;
function ProductDetailPage({ slug }) {
    _s4();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { detailSlug, setDetailSlug, addToCart, setActiveTab, setShopSubPath } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    const [selectedSize, setSelectedSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [notifyEmail, setNotifyEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [notifySent, setNotifySent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [sidebarCats, setSidebarCats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const activeSlug = slug || detailSlug;
    const product = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductDetailPage.useMemo[product]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALL_PRODUCTS"].find({
                "ProductDetailPage.useMemo[product]": (p)=>p.slug === activeSlug
            }["ProductDetailPage.useMemo[product]"])
    }["ProductDetailPage.useMemo[product]"], [
        activeSlug
    ]);
    const available = product ? product.stock > 0 : false;
    const enriched = product ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enrichProduct"])(product) : null;
    const related = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductDetailPage.useMemo[related]": ()=>{
            if (!product) return [];
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALL_PRODUCTS"].filter({
                "ProductDetailPage.useMemo[related]": (p)=>p.albumSlug === product.albumSlug && p.slug !== product.slug
            }["ProductDetailPage.useMemo[related]"]).slice(0, 4);
        }
    }["ProductDetailPage.useMemo[related]"], [
        product
    ]);
    const openRelated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductDetailPage.useCallback[openRelated]": (p)=>{
            router.push(`/shop/${p.slug}`);
            setSelectedSize(null);
            setNotifySent(false);
        }
    }["ProductDetailPage.useCallback[openRelated]"], [
        router
    ]);
    const handleAddToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductDetailPage.useCallback[handleAddToCart]": ()=>{
    ...
    const handleNotify = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductDetailPage.useCallback[handleNotify]": ()=>{
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: ()=>{
                                const parentAlbum = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SHOP_ALBUMS"].find((a)=>a.slug === product.albumSlug);
                                if (parentAlbum) {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        enriched.sku && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                enriched.availability === "Low Stock" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                enriched.sizes.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-8",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex flex-wrap gap-2",
                                            children: enriched.sizes.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: available ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        lineNumber: 675,
                                        columnNumber: 17
                                    }, this) : notifySent ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                related.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: related.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProductCard, {
                                    product: p,
...
_s4(ProductDetailPage, "i/8tKU4K8NUmyvQKn7CV6ozV4Xo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
_c11 = ProductDetailPage;
/* ═══════════════════════════════════════════════════
   SHOP CATALOG PRODUCT DETAIL PAGE (new 754-product catalog)
   ═══════════════════════════════════════════════════ */ function ShopCatalogDetailPage({ product }) {
    _s5();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { addToCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    const [selectedSize, setSelectedSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-8 flex items-center gap-6 flex-wrap",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        product.department && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        product.category && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "text-[11px] uppercase tracking-[0.2em] text-black/30",
                            children: product.category
                        }, void 0, false, {
                            fileName: "[project]/src/components/adea/Shop.tsx",
                            lineNumber: 739,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "grid grid-cols-1 gap-8 md:grid-cols-[1fr_1fr] md:gap-12",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "relative aspect-square overflow-hidden bg-[#f4f4f4]",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex h-full w-full items-center justify-center",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shopping$2d$bag$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShoppingBag$3e$__["ShoppingBag"], {
                                        className: "h-16 w-16 text-black/8"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/adea/Shop.tsx",
                                        lineNumber: 746,
                                        columnNumber: 15
                                ...
                                product.badges.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: product.badges.map((badge)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "px-3 py-1 text-[10px] font-medium uppercase tracking-wider bg-black text-white",
                                            children: badge
                                        }, badge, false, {
                                            fileName: "[project]/src/components/adea/Shop.tsx",
                                            lineNumber: 751,
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        product.category && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-[10px] uppercase tracking-[0.2em] text-black/30",
                                            children: product.category
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/adea/Shop.tsx",
                                            lineNumber: 763,
                                        ...
                                        product.subcategory && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-[10px] uppercase tracking-[0.2em] text-black/20",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    className: "mt-4 text-display text-[clamp(1.8rem,4vw,3.5rem)] leading-[0.9] text-black",
                                    children: product.name
                                }, void 0, false, {
                                    fileName: "[project]/src/components/adea/Shop.tsx",
                                    lineNumber: 770,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        displayOriginal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-lg text-black/30 line-through",
                                            children: displayOriginal
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/adea/Shop.tsx",
                                            lineNumber: 777,
                                ...
                                product.sku && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "mt-2 text-[10px] font-mono tracking-wider text-black/30",
                                    children: [
                                        "SKU: ",
                                        product.sku
                                    ]
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-6 border-t border-black/5 pt-6 space-y-3",
                                    children: [
                                        product.fabric && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex justify-between",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-[11px] uppercase tracking-[0.15em] text-black/40",
                                                    children: "Fabric"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/adea/Shop.tsx",
                                                    lineNumber: 788,
                                        ...
                                        product.material && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex justify-between",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-[11px] uppercase tracking-[0.15em] text-black/40",
                                        ...
                                        product.beautySize && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex justify-between",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-[11px] uppercase tracking-[0.15em] text-black/40",
                                        ...
                                        product.colorCount && product.colorCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex justify-between",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-[11px] uppercase tracking-[0.15em] text-black/40",
                                        ...
                                        product.tags && product.tags.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: product.tags.slice(0, 5).map((tag)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-[10px] text-black/50 bg-black/5 px-2 py-0.5",
                                                            children: tag
                                                        }, tag, false, {
                                                            fileName: "[project]/src/components/adea/Shop.tsx",
                                                            lineNumber: 821,
                                ...
                                hasSizes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-8",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "mb-3 text-[10px] uppercase tracking-[0.2em] text-black",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex flex-wrap gap-2",
                                            children: product.sizeList.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: ()=>setSelectedSize(s),
                                                    className: `h-10 min-w-[44px] px-3 text-[11px] uppercase tracking-wider border transition-all cursor-pointer ${selectedSize === s ? "bg-black text-white border-black" : "bg-white text-black border-black/15 hover:border-black/40"}`,
                                                    children: s
                                                }, s, false, {
                                                    fileName: "[project]/src/components/adea/Shop.tsx",
                                                    lineNumber: 835,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-8",
                                    children: product.price > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>addToCart(),
                                        className: "w-full bg-black py-4 text-[12px] uppercase tracking-[0.2em] text-white hover:bg-black/80 transition-colors cursor-pointer",
                                        children: "Add to Cart"
                                    }, void 0, false, {
                                        ...
                                        className: "border border-black/10 py-4 text-center text-[12px] text-black/50",
                                        children: "Contact for pricing and availability"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/adea/Shop.tsx",
                                        lineNumber: 860,
                                        columnNumber: 17
...
_s5(ShopCatalogDetailPage, "mfvfTbr40XLnp2c0N5wHVCfr6xQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
_c12 = ShopCatalogDetailPage;
function AdminProductDetailPage({ product }) {
    _s6();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { addToCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    const [selectedSize, setSelectedSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                product.badges && product.badges.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "absolute left-4 top-4 flex flex-col gap-2",
                                    children: product.badges.map((badge)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "px-3 py-1 text-[10px] font-medium uppercase tracking-wider bg-black text-white",
                                            children: badge
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        hasColors && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: product.colors.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "flex items-center gap-1 text-[10px] text-black",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s6(AdminProductDetailPage, "mfvfTbr40XLnp2c0N5wHVCfr6xQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
_c13 = AdminProductDetailPage;
function ShopDetailRouter({ slug }) {
    _s7();
    const [adminProduct, setAdminProduct] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [adminLoading, setAdminLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // Check new shop-catalog first (754 products)
    const shopProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shop$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductBySlug"])(slug);
    if (shopProduct) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ShopCatalogDetailPage, {
            product: shopProduct
        }, void 0, false, {
            fileName: "[project]/src/components/adea/Shop.tsx",
            lineNumber: 1076,
    ...
    const legacyProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$product$2d$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductById"])(slug);
    if (legacyProduct) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$portal$2f$pages$2f$PortalProductDetailPage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            productId: slug
        }, void 0, false, {
            fileName: "[project]/src/components/adea/Shop.tsx",
            lineNumber: 1082,
    ...
    const isAlbum = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SHOP_ALBUMS"].some((a)=>a.slug === slug);
    const isProduct = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALL_PRODUCTS"].some((p)=>p.slug === slug);
    if (isAlbum) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AlbumDetailPage, {
        slug: slug
    }, void 0, false, {
        fileName: "[project]/src/components/adea/Shop.tsx",
        lineNumber: 1089,
    ...
    if (isProduct) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProductDetailPage, {
        slug: slug
    }, void 0, false, {
        fileName: "[project]/src/components/adea/Shop.tsx",
        lineNumber: 1090,
    ...
    // Check admin-managed product (async, since it's from the database)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShopDetailRouter.useEffect": ()=>{
            fetch(`/api/shop/admin-products/slug?slug=${encodeURIComponent(slug)}`).then({
                "ShopDetailRouter.useEffect": (r)=>r.json()
            }["ShopDetailRouter.useEffect"]).then({
                "ShopDetailRouter.useEffect": (res)=>{
                    if (res.success) setAdminProduct(res.data);
                }
            }["ShopDetailRouter.useEffect"]).catch({
                "ShopDetailRouter.useEffect": ()=>{}
            }["ShopDetailRouter.useEffect"]).finally({
                "ShopDetailRouter.useEffect": ()=>setAdminLoading(false)
            }["ShopDetailRouter.useEffect"]);
        }
    }["ShopDetailRouter.useEffect"], [
        slug
    ...
    if (adminLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex min-h-screen items-center justify-center bg-white",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "animate-pulse text-sm text-black/30",
                children: "Loading..."
            }, void 0, false, {
                fileName: "[project]/src/components/adea/Shop.tsx",
                lineNumber: 1106,
    ...
    if (adminProduct) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AdminProductDetailPage, {
...
_s7(ShopDetailRouter, "hCyRKL88oBYOgZVuKdqa0bVMN5I=");
_c14 = ShopDetailRouter;
var _c, _c1, _c2, _c3, _c4, _c5, _c6, _c7, _c8, _c9, _c10, _c11, _c12, _c13, _c14;
__turbopack_context__.k.register(_c, "StreamingOverlay");
__turbopack_context__.k.register(_c1, "ProductCard");
__turbopack_context__.k.register(_c2, "CategorySidebar");
__turbopack_context__.k.register(_c3, "SizeFilter");
__turbopack_context__.k.register(_c4, "ShopNav");
__turbopack_context__.k.register(_c5, "AlbumsView");
__turbopack_context__.k.register(_c6, "CollectionsView");
__turbopack_context__.k.register(_c7, "ShopAllView");
__turbopack_context__.k.register(_c8, "ShopPage");
__turbopack_context__.k.register(_c9, "AlbumActionList");
__turbopack_context__.k.register(_c10, "AlbumDetailPage");
__turbopack_context__.k.register(_c11, "ProductDetailPage");
__turbopack_context__.k.register(_c12, "ShopCatalogDetailPage");
__turbopack_context__.k.register(_c13, "AdminProductDetailPage");
__turbopack_context__.k.register(_c14, "ShopDetailRouter");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_ad961271._.js.map