...
| `_std` | XS/S – 3XL–8XL | All print-on-demand items (varies per style, always shown per-product) |
...
### Activewear — Sports Bras / Yoga / Leggings (`_apparel`)
| Name | SKU | Sizes | Colors | Fabric | Price |
|---|---|---|---|---|---|
...
### One-Pieces — Dresses / Rompers / Jumpsuits (`_apparel`)
| Name | SKU | Sizes | Colors | Fabric | Price |
|---|---|---|---|---|---|
...
### Bottoms — Jeans / Trousers / Sweatpants / Shorts (`_apparel`)
| Name | SKU | Sizes | Colors | Fabric | Price |
|---|---|---|---|---|---|
...
## PART A —  Apparel (Women's, SKU-coded)
...
| 310gsm Wearable Sweater et Oversize | One size | From $12.81 | — |
...
| 310gsm Adult Hooded et Sweatshirt | One size | From $11.53 | — |
